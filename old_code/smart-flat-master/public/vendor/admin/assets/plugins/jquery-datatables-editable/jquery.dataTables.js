        ...
        /** @lends <global> */ function ($) {
            ...
            function _fnFilterComplete(oSettings, oInput, iForce) {
                ...
                var fnRegex = function (o) {
                    ...
                    return o.bEscapeRegex !== undefined
                        ? !o.bEscapeRegex
                        : o.bRegex;
                };
            ...
            function _fnFilter(
                ...
                if (input.length <= 0) {
                    ...
                    for (i = display.length - 1; i >= 0; i--) {
                        if (
                            !rpSearch.test(
                                settings.aoData[display[i]]._sFilterRow,
                            )
                        ) {
                            display.splice(i, 1);
                        }
            ...
            var __filter_div_textContent =
                __filter_div.textContent !== undefined;
            ...
            function _fnFeatureHtmlPaginate(settings) {
                var type = settings.sPaginationType,
                    ...
                    node = $('<div/>').addClass(
                        settings.oClasses.sPaging + type,
                    )[0],
                        ...
                        fn: function (settings) {
                            if (modern) {
                                var start = settings._iDisplayStart,
                                    ...
                                    pages = all
                                        ? 1
                                        : Math.ceil(visRecords / len),
                                    buttons = plugin(page, pages),
                                    i,
                                    ien;

                                for (
                                    i = 0, ien = features.p.length;
                                    i < ien;
                                    i++
                                ) {
            ...
            function _fnFeatureHtmlTable(settings) {
                ...
                var captionSide = caption.length
                    ? caption[0]._captionSide
                    : null;
            ...
            function _fnScrollDraw(settings) {
                ...
                if (footer) {
                    ...
                    _fnApplyToChildren(function (nSizer) {
                        footerWidths.push(
                            _fnStringToCss($(nSizer).css('width')),
                        );
                    }, footerSrcEls);
                ...
                if (footer) {
                    settings.nScrollFoot.style.width =
                ...
                divHeaderInnerStyle[padding] = bScrolling
                    ? barWidth + 'px'
                    : '0px';
            ...
            function _fnCalculateColumnWidths(oSettings) {
                ...
                if (
                    ...
                    for (i = 0; i < columnCount; i++) {
                        columns[i].sWidth = _fnStringToCss(
                ...
                for (var i = 0, iLen = columns.length; i < iLen; i++) {
                    ...
                    if (col.bSortable) {
                        if (aSort.length > 0 && aSort[0].col == i) {
                            ...
                            nextSort =
                                asSorting[aSort[0].index + 1] || asSorting[0];
                        } else {
            ...
            DataTable = function (options) {
                ...
                this.fnGetData = function (src, col) {
                    ...
                    if (src !== undefined) {
                        var type = src.nodeName
                            ? src.nodeName.toLowerCase()
                            : '';
                    ...
                    if (rowOne.length) {
                        ...
                        $.each(
                            ...
                            function (i, cell) {
                                ...
                                if (col.mData === i) {
                                    var sort =
                                        a(cell, 'sort') || a(cell, 'order');
                                    var filter =
                                        a(cell, 'filter') || a(cell, 'search');
            ...
            var _selector_run = function (
                ...
                for (i = 0, ien = selector.length; i < ien; i++) {
                    ...
                    for (j = 0, jen = a.length; j < jen; j++) {
                        res = selectFn(
                            typeof a[j] === 'string' ? $.trim(a[j]) : a[j],
                        );
            ...
            DataTable.isDataTable = DataTable.fnIsDataTable = function (table) {
                ...
                $.each(DataTable.settings, function (i, o) {
                    var head = o.nScrollHead
                        ? $('table', o.nScrollHead)[0]
                        : null;
                    var foot = o.nScrollFoot
                        ? $('table', o.nScrollFoot)[0]
                        : null;
                ...
                return this.iterator('table', function (settings) {
                    ...
                    if (ien) {
                        jqTbody.children().each(function (i) {
                            $(this).addClass(
                                settings.asDestroyStripes[i % ien],
                            );
                        });
                    }
            ...
            $.extend(DataTable.ext.type.detect, [
                ...
                function (d, settings) {
                    var decimal = settings.oLanguage.sDecimal;
                    return _isNumber(d, decimal, true)
                        ? 'num-fmt' + decimal
                        : null;
                },
