            ...
            var e = {},
                ...
                g = function () {
                    ...
                    for (var a in d)
                        d.hasOwnProperty(a) &&
                            ((e[a] =
                                c && 'undefined' != typeof c[a] ? c[a] : d[a]),
                            'function' == typeof e[a] &&
                                (e[a] = e[a].bind(this)));
                    ((e.easing =
                        ...
                        (this.renderer = new e.renderer(b, e)),
                        this.renderer.draw(f),
                        b.dataset && b.dataset.percent
                            ? this.update(parseFloat(b.dataset.percent))
                            : b.getAttribute &&
                              b.getAttribute('data-percent') &&
                              this.update(
                                  parseFloat(b.getAttribute('data-percent')),
                              ));
                }.bind(this);
