asynctest(
    ...
    function (
        ...
        var contains = function (a, b) {
            return (
                containsXY(a, b.x, b.y) && containsXY(a, b.x + b.w, b.y + b.h)
            );
        };
        ...
        var sAssertRect = function (editor, measure) {
            return Step.sync(function () {
                ...
                Assertions.assertEq(
                    'Rect is not in page area rect',
                    contains(pageAreaRect, elementRect),
                    true,
                );
                Assertions.assertEq(
                    'Rect is not in content area rect',
                    contains(contentAreaRect, elementRect),
                    true,
                );
                Assertions.assertEq(
                    'Rect should have width',
                    elementRect.w > 0,
                    true,
                );
                Assertions.assertEq(
                    'Rect should have height',
                    elementRect.h > 0,
                    true,
                );
            });
            ...
            function (editor, onSuccess, onFailure) {
                ...
                Pipeline.async(
                    ...
                    [
                        ...
                        sAssertRect(
                            editor,
                            getSelectionRectFromSelector(editor),
                        ),
                    ],
                    onSuccess,
                    onFailure,
