!(function (a, b) {
    ...
    (d('tinymce/codesampleplugin/Prism', [], function () {
                ...
                var a = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
                    c = (b.Prism = {
                        ...
                        highlightElement: function (d, e, f) {
                            ...
                            if (
                                (c.hooks.run('before-highlight', k),
                                e && b.Worker)
                            ) {
        ...
        return (
            ...
            (c.languages.css.atrule.inside.rest = c.util.clone(
                c.languages.css,
            )),
            c.languages.markup &&
        ...
        d('tinymce/codesampleplugin/Utils', [], function () {
            function a(a) {
                return (
                    a &&
                    'PRE' == a.nodeName &&
                    -1 !== a.className.indexOf('language-')
                );
            }
            function b(a) {
                return function (b, c) {
            ...
            function (a, b, c) {
                ...
                function g(a) {
                    var b,
                        c = e(a);
                    return c
                        ? ((b = c.className.match(/language-(\w+)/)),
                          b ? b[1] : '')
                        : '';
                }
                var h = a.DOM,
