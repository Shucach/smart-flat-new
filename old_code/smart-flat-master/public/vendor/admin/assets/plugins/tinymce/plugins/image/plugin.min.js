    ...
    function e(d) {
        ...
        function f() {
            ...
            (j(),
                ...
                a.undoManager.transact(function () {
                    ...
                    if (!s.src)
                        return void (
                            m && (t.remove(m), a.focus(), a.nodeChanged())
                        );
                    if (
        ...
        function j() {
            ...
            if (a.settings.image_advtab) {
                ...
                ((d = i(d)),
                    c.vspace &&
                        (d['margin-top'] = d['margin-bottom'] = b(c.vspace)),
                    c.hspace &&
                        (d['margin-left'] = d['margin-right'] = b(c.hspace)),
                    c.border && (d['border-width'] = b(c.border)),
                    l
                        .find('#style')
                        .value(
                            t.serializeStyle(t.parseStyle(t.serializeStyle(d))),
                        ));
            }
        }
        function k() {
                ...
                (l.find('#vspace').value(''),
                    ...
                    ((c['margin-top'] && c['margin-bottom']) ||
                        ...
                        c['margin-right'] === c['margin-left']
                            ...
                            : l.find('#hspace').value('')),
                    c['border-width'] &&
                        l.find('#border').value(g(c['border-width'])),
                    l
                        .find('#style')
                        .value(
                            t.serializeStyle(t.parseStyle(t.serializeStyle(c))),
                        ));
            }
        }
        var l,
        ...
        (a.settings.image_description !== !1 &&
            ...
            a.settings.image_advtab
                ? (m &&
                      ...
                      m.style.borderWidth &&
                          (s.border = g(m.style.borderWidth)),
