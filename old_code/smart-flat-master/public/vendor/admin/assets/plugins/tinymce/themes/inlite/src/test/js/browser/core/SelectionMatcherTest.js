asynctest(
    ...
    function (
        ...
        var sTextSelectionTest = function (
            tinyApis,
            editor,
            inputHtml,
            spath,
        ...
        var sEmptyTextBlockTest = function (
            tinyApis,
            editor,
            inputHtml,
            spath,
            ...
            var sAssertTextSelectionResult = Step.sync(function () {
                var elements = editor.dom.getParents(
                    editor.selection.getStart(),
                );
                var result = SelectionMatcher.emptyTextBlock(
                    elements,
                    'a',
                )(editor);
                assertResult(expectedResultState, result);
