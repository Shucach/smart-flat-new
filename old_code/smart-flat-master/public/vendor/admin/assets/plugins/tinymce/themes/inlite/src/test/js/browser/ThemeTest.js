asynctest(
    ...
    function (
        ...
        var sWaitForToolbar = function () {
            return Chain.asStep({}, [cWaitForContextToolbar]);
        };
        ...
        var sLinkTests = function (tinyApis) {
            var sContentActionTest = function (
                inputHtml,
                spath,
                soffset,
                fpath,
            ...
            var sLinkWithConfirmOkTest = function (
                inputHtml,
                spath,
                soffset,
                fpath,
                ...
                return sContentActionTest(
                    ...
                    foffset,
                    expectedHtml,
                    sInsertLinkConfirmPrefix(url, 'Ok'),
                );
            };

            var sLinkWithConfirmCancelTest = function (
                inputHtml,
                spath,
                soffset,
                fpath,
                ...
                return sContentActionTest(
                    ...
                    foffset,
                    expectedHtml,
                    sInsertLinkConfirmPrefix(url, 'Cancel'),
                );
            };

            return GeneralSteps.sequence([
                sLinkWithConfirmOkTest(
                    '<p>a</p>',
                    [0, 0],
                    0,
                    [0, 0],
        ...
        TinyLoader.setup(
            function (editor, onSuccess, onFailure) {
                var tinyApis = TinyApis(editor),
                    tinyActions = TinyActions(editor);
