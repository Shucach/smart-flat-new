    ...
    function (
        ...
        var cAssertRangeEq = function (expected) {
            return Chain.op(function (actual) {
                Assertions.assertEq(
                    'Not equal startContainer',
                    expected.start().dom(),
                    actual.startContainer,
                );
                Assertions.assertEq(
                    'Not equal startOffset',
                    expected.soffset(),
                    actual.startOffset,
                );
                Assertions.assertEq(
                    'Not equal endContainer',
                    expected.finish().dom(),
                    actual.endContainer,
                );
                Assertions.assertEq(
        ...
        Pipeline.async(
            ...
            [
                ...
                sTestBookmark('<b>a</b>', { element: [0, 0], offset: 0 }),
                sTestBookmark('<b>a</b>', {
                    start: { element: [0, 0], offset: 0 },
                    finish: { element: [0, 0], offset: 1 },
                }),
                sTestBookmark('<b>a</b><b>b</b>', {
                    start: { element: [0, 0], offset: 0 },
                    finish: { element: [1, 0], offset: 1 },
                }),
            ],
            function () {
                success();
