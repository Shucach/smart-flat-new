...
(function (e, t) {
    function a() {
        ...
        ((e.id = null),
            ...
            (e.stop = function () {
                null !== e.id &&
                    (clearTimeout(e.id), (e.id = null), (e.busy = !1));
            }));
    }
    function i(i, o, n) {
        var r = this;
        ...
        return (
                        ...
                        if (o.toggle) {
                            ...
                            return (
                                t
                                    ...
                                    .not('.' + d.detailCell)
                                    .prepend(
                                        e(l.toggleHTMLElement).addClass(
                                            d.toggle,
                                        ),
                                    ),
                                undefined
            ...
            (r.getColumnData = function (t) {
                ...
                for (var m in l.breakpoints)
                    ((n.hide[m] =
                        'all' === a.data('hide') || e.inArray(m, i) >= 0),
                        (h = h || n.hide[m]));
                n.hasBreakpoint = h;
            ...
            (r.resize = function () {
                ...
                if (t.is(':visible')) {
                    ...
                    if (
                        ...
                        for (
                            var o, n = null, l = 0;
                            r.breakpoints.length > l;
                            l++
                        )
                            if (
                                ((o = r.breakpoints[l]),
                                o && o.width && a.width <= o.width)
                            ) {
                                n = o;
                                break;
                            }
                ...
                (t
                    ...
                    .each(function () {
                        ...
                        if (
                            ...
                            1 ===
                                t.find('> thead > tr.footable-group-row')
                                    .length)
                        ) {
                            var s = t.find(
                    ...
                    t
                        .find('> tbody > tr.' + d.detailShow + ':visible')
                        .each(function () {
                            var t = e(this).next();
            ...
            (r.toggleInput = function (t) {
                ...
                if (null != a) {
                    ...
                    null != i &&
                        (e(t).is(':visible')
                            ? e(i).is(':empty') ||
                              e(t).html(e(i).contents().detach())
                            : e(t).is(':empty') ||
                              e(i).html(e(t).contents().detach()));
                }
            }),
            r.init(),
            r
    ...
    t.footable = {
        ...
        version: {
            ...
            toString: function () {
                return (
                    t.footable.version.major + '.' + t.footable.version.minor
                );
            },
            parse: function (e) {
                var t = /(\d+)\.?(\d+)?\.?(\d+)?/.exec(e);
        ...
        plugins: {
            ...
            register: function (a, i) {
                t.footable.plugins._validate(a) &&
                    ...
                    'object' == typeof i &&
                        e.extend(!0, t.footable.options, i));
            },
            load: function (e) {
                var a,
                    i,
...
(function (e, t, undefined) {
    ...
    function o(t, o) {
        ...
        for (
            var n = e('<tr>').appendTo(i), r = 0, l = o.cols.length;
            l > r;
            r++
        )
            n.append(a(o.cols[r]));
    ...
    function n(t, a, o) {
        if (o) {
            ...
            var i = t.find('tfoot');
            (0 === i.size() &&
                (i = e('<tfoot class="hide-if-no-paging"></tfoot>').appendTo(
                    t,
                )),
    ...
    function r(t) {
        for (var a = t[0], o = 0, i = t.length; i > o; o++) {
            var n = t[o];
            if (n.data && (n.data.toggle === !0 || 'true' === n.data.toggle))
                return;
        }
    ...
    function d(t, a, o, i) {
        t.find('tr:not(.' + o + ')').each(function () {
            ...
            n >= o &&
                this !== a.get(0) &&
                t.attr('data-index', r).data('index', r);
        });
    }
    function s() {
        function t(t, a, o) {
            var i = e('<td>');
            return (
                t.formatter ? i.html(t.formatter(a, i, o)) : i.html(a || ''), i
            );
        }
        var a = this;
        ((a.name = 'Footable Grid'),
                            ...
                            .on(
                                ...
                                function (e) {
                                    ...
                                    (t
                                        ...
                                        u
                                            .find('tbody input:checkbox.check')
                                            .prop('checked', t));
                                },
                            ));
                }
            ...
            (a.newItem = function (t, o, i) {
                ...
                if ((n.find('tr.emptyInfo').remove(), e.isArray(t))) {
                    ...
                    return (
                        a.footable.redraw(),
                        a.footable.raise(
                            a.footable.options.grid.events.created,
                            { item: t, index: o },
                        ),
                        undefined
                    );
            ...
            (a.setItem = function (t, o) {
                if (e.isPlainObject(t)) {
                    ...
                    (r.html(n.html()),
                        a.footable.redraw(),
                        a.footable.raise(
                            a.footable.options.grid.events.updated,
                            { item: t, index: o },
                        ));
                }
            }),
            (a.removeItem = function (t) {
                ...
                if (e.isArray(t)) {
                    ...
                    return (
                        a.footable.raise(
                            a.footable.options.grid.events.removed,
                            { item: n, index: t },
                        ),
                        n
                    );
                                ...
                                'footable_initialized.filtering': function () {
                                    var i = t(a.table),
                                        o = {
                                            input:
                                                i.data('filter') ||
                                                a.options.filter.input,
                                            timeout:
                                                i.data('filter-timeout') ||
                                                a.options.filter.timeout,
                                            minimum:
                                                i.data('filter-minimum') ||
                                                a.options.filter.minimum,
                                            disableEnter:
                                                i.data(
                    ...
                    if (l.clear) e.clearFilter();
                        ...
                        (t.each(d, function (t, e) {
                            e &&
                                ...
                                (s = s.filter(
                                    i.options.filter.filterFunction,
                                )));
                        }),
                            s.each(function () {
                                (e.showRow(this, i),
    ...
    function i() {
        ...
        ((t.name = 'Footable Paginate'),
                    ...
                    (r.push(t),
                        e === n - 1
                            ? (o.pages.push(r),
                              ...
                              (n = i * o.pageSize),
                              (r = []))
                            : e >= d.length - (d.length % o.pageSize) &&
                              l.push(t));
                }),
            ...
            (t.createLimited = function (e, t, a) {
                ...
                (0 === a ? n.hide() : n.show(),
                    a + t.limitNavigation >= t.pages.length
                        ? r.hide()
                        : r.show());
            }),
                        ...
                        t(a.table)
                            ...
                            .bind({
                                ...
                                'footable_redrawn.sorting': function () {
                                    ...
                                    i.data('sorted') >= 0 &&
                                        i
                                            ...
                                            .each(function (a) {
                                                var i = t(this);
                                                return i.hasClass(o.sorted) ||
                                                    i.hasClass(o.descending)
                                ...
                                'footable_column_data.sorting': function (e) {
                                    ...
                                    (i >= e.column.data.matches.length &&
                                        (i = 0),
                                        (e.column.data.sort.match =
                                            e.column.data.matches[i]));
                                },
                            })
                ...
                e.options.bookmarkable.enabled &&
                    t(e.table).bind({
                        footable_initialized: function () {
                            ...
                            if (
                                (n && t(e.table).data('currentPage', n),
                                r !== undefined)
                            ) {
