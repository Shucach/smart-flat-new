...
(function (factory) {
    ...
    var menu = $.widget('ui.menu', {
        ...
        focus: function (event, item) {
            ...
            if (nested.length && event && event.type.startsWith('mouse')) {
    ...
    $.widget('ui.autocomplete', {
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function (event, ui) {
                    ...
                    if (this.isNewMenu) {
                        ...
                        if (
                            event.originalEvent &&
                            event.originalEvent.type.startsWith('mouse')
                        ) {
                            this.menu.blur();
                    ...
                    if (
                        ...
                        if (
                            event.originalEvent &&
                            event.originalEvent.type.startsWith('key')
                        ) {
        ...
        _move: function (direction, event) {
            ...
            if (
                (this.menu.isFirstItem() && direction.startsWith('previous')) ||
                (this.menu.isLastItem() && direction.startsWith('next'))
            ) {
                if (!this.isMultiLine) {
                    this._value(this.term);
                }
...
*/
    ...
    var slider = $.widget('ui.slider', $.ui.mouse, {
        ...
        _calculateNewMax: function () {
            var max = this.options.max,
                ...
                aboveMin =
                    Math.floor(+(max - min).toFixed(this._precision()) / step) *
                    step;
            max = aboveMin + min;
    ...
    var tooltip = $.widget('ui.tooltip', {
        ...
        _open: function (event, target, content) {
            ...
            if (this.options.track && event && event.type.startsWith('mouse')) {
                this._on(this.document, {
                    mousemove: position,
                });
