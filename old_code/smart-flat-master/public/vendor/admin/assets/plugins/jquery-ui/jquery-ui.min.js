            ...
            t.dpDiv.find('[data-handler]').map(function () {
                var t = {
                    ...
                    selectMonth: function () {
                        return (
                            e.datepicker._selectMonthYear(s, this, 'M'), !1
                        );
                    },
                    selectYear: function () {
                        return (
                            e.datepicker._selectMonthYear(s, this, 'Y'), !1
                        );
                    },
                };
                e(this).bind(
            ...
            _mouseCapture: function (t) {
                ...
                for (i in this.handles)
                    ((s = e(this.handles[i])[0]),
                        (s === t.target || e.contains(s, t.target)) &&
                            (n = !0));
