!(function (a, b) {
    function c(b) {
        ...
        if (
            ...
            if (!h)
                return (a.console.error('Unknown alert type: ' + b.type), !1);
                ...
                switch (typeof arguments[0]) {
                    ...
                    case 'object':
                        if (void 0 === arguments[0].title)
                            return (
                                a.console.error('Missing "title" argument!'), !1
                            );
                        ((m.title = arguments[0].title),
                            ...
                            (m.cancelButtonClass =
                                ...
                                o.cancelButtonClass),
                            (m.containerClass =
                                arguments[0].containerClass ||
                                o.containerClass),
                            (m.titleClass =
                                arguments[0].titleClass || o.titleClass),
                            (m.textClass =
                                arguments[0].textClass || o.textClass),
                            (m.imageUrl = arguments[0].imageUrl || o.imageUrl),
                            (m.imageSize =
                                arguments[0].imageSize || o.imageSize),
