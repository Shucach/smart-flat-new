    ...
    ((d.prototype = {
                ...
                b('<tr>')
                    ...
                    .append(
                        b('<td>')
                            .attr('colspan', a)
                            .append(
                                this.renderTemplate(this.noDataContent, this),
                            ),
                    )
            );
        },
        ...
        _createCell: function (a, c) {
            ...
            return (
                (d = b.isFunction(c.cellRenderer)
                    ...
                    : b('<td>').append(
                          this.renderTemplate(c.itemTemplate || e, c, f),
                      )),
        ...
        getFilter: function () {
            ...
            return (
                this._eachField(function (b) {
                    b.filtering &&
                        this._setItemFieldValue(a, b, b.filterValue());
                }),
                a
            );
        },
        ...
        _getInsertItem: function () {
            ...
            return (
                this._eachField(function (b) {
                    b.inserting &&
                        this._setItemFieldValue(a, b, b.insertValue());
                }),
                a
            );
        },
        _validateItem: function (a, d) {
            var e = [],
                f = { item: a, itemIndex: this._rowIndex(d), row: d };
            if (
                (this._eachField(function (g) {
                    if (g.validate) {
                        var h = this._getItemFieldValue(a, g);
                        if (h !== c) {
                            var i = this._validation.validate(
                                b.extend({ value: h, rules: g.validate }, f),
                            );
                            (this._setCellValidity(
                                d.children().eq(this._visibleFieldIndex(g)),
                                i,
                            ),
                                i.length &&
                                    e.push.apply(
                ...
                return !0;
            var g = b.extend({ errors: e }, f);
            return (
                this._callEventHandler(this.onItemInvalid, g),
                this.invalidNotify(g),
                !1
            );
        },
        _setCellValidity: function (a, b) {
            a.toggleClass(this.invalidClass, !!b.length).attr(
                'title',
                b.join('\n'),
            );
        },
        ...
        ((c.prototype = {
            ...
            show: function () {
                var a = this._loadPanel.show(),
                    b = a.outerWidth(),
                    c = a.outerHeight();
                (a.css({ marginTop: -c / 2, marginLeft: -b / 2 }),
                    this._shader.show());
            },
            hide: function () {
    ...
    (function (a, b, c) {
        ...
        ((d.prototype = {
            ...
            headerTemplate: function () {
                return this.title === c || null === this.title
                    ? this.name
                    : this.title;
            },
        ...
        ((c.prototype = new d({
            ...
            itemTemplate: function (a, c) {
                ...
                return (
                    ...
                    this.deleteButton &&
                        (d = d.add(this._createDeleteButton(c))),
                    d
                );
            },
            filterTemplate: function () {
