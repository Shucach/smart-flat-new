    ...
    Grid.prototype = {
            ...
            self.fields = $.map(self.fields, function (field) {
                if ($.isPlainObject(field)) {
                    var fieldConstructor =
                        (field.type && jsGrid.fields[field.type]) ||
                        jsGrid.Field;
        ...
        _createHeader: function () {
            ...
            var $header = (this._header = $('<div>')
                ...
                .addClass(
                    this._scrollBarWidth() ? 'jsgrid-header-scrollbar' : '',
                )
                .append($headerGrid));
        ...
        _getRowClasses: function (item, itemIndex) {
            var classes = [];
            classes.push(
                (itemIndex + 1) % 2 ? this.oddRowClass : this.evenRowClass,
            );
        ...
        _sortData: function () {
            ...
            if (sortField) {
                this.data.sort(function (item1, item2) {
                    return (
                        sortFactor *
                        sortField.sortingFunc(
                            item1[sortField.name],
                            item2[sortField.name],
                        )
                    );
                });
            }
        ...
        _pagesCount: function () {
            ...
            return (
                Math.floor(itemsCount / pageSize) +
                (itemsCount % pageSize ? 1 : 0)
            );
        },
        ...
        _createEditRow: function (item) {
            if ($.isFunction(this.editRowRenderer)) {
                return $(
                    this.renderTemplate(field.editRowRenderer, field, {
                        item: item,
                        itemIndex: this._itemIndex(item),
                    }),
                );
        ...
        _deleteRow: function ($row) {
            ...
            return this._controllerCall(
                ...
                args.cancel,
                function () {
                    this._loadStrategy.finishDelete(
                        deletingItem,
                        deletingItemIndex,
                    );
...
(function (jsGrid, $, undefined) {
    ...
    SelectField.prototype = new NumberField({
        ...
        filterValue: function () {
            ...
            return this.valueType === numberValueType
                ? parseInt(val || 0, 10)
                : val;
        },
...
(function (jsGrid, $, undefined) {
    ...
    ControlField.prototype = new Field({
        ...
        editTemplate: function () {
            return this._createUpdateButton().add(
                this._createCancelEditButton(),
            );
        },
