...
!(function (a) {
                    ...
                    f
                        ...
                        : e &&
                          (g
                              ? (i._ambigZone = !0)
                              : k &&
                                (i.utcOffset ? i.utcOffset(j) : i.zone(j)))),
            (i._fullCalendar = !0),
            i
        );
    }
    ...
    ((Wa.moment = function () {
        ...
        (gb.clone = function () {
            ...
            return (
                na(this, a), this._fullCalendar && (a._fullCalendar = !0), a
            );
        }),
        (gb.week = gb.weeks =
            function (a) {
    ...
    var lb = (Wa.EmitterMixin = {
            ...
            triggerWith: function (b, c, d) {
                return (
                    a(this).triggerHandler(b, { context: c, args: d }), this
                );
            },
        }),
    ...
    var xb = (Wa.View = ya.extend(lb, mb, {
            ...
            isHiddenDay: function (a) {
                return (
                    b.isMoment(a) && (a = a.day()), this.isHiddenDayHash[a]
                );
            },
