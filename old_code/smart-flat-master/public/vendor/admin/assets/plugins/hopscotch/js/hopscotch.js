            ...
            if (typeof step.target === 'string') {
                ...
                for (i = 0, len = step.target.length; i < len; i++) {
                    if (typeof step.target[i] === 'string') {
                        queriedTarget = utils.getStepTargetHelper(
                            step.target[i],
                        );
        ...
        setPosition: function (step) {
            ...
            if (!arrowOffset) {
                ...
                if (arrowOffset === 'center') {
                    arrowEl.style[arrowPos] =
                        Math.floor(
                            bubbleBoundingWidth / 2 - arrowEl.offsetWidth / 2,
                        ) + 'px';
                } else {
                    // Numeric pixel value
                ...
                if (arrowOffset === 'center') {
                    arrowEl.style.top =
                        Math.floor(
                            bubbleBoundingHeight / 2 - arrowEl.offsetHeight / 2,
                        ) + 'px';
                } else {
                    // Numeric pixel value
        ...
        render: function (step, idx, callback) {
            ...
            opts = {
                ...
                step: {
                    ...
                    padding: utils.valOrDefault(
                        step.padding,
                        this.opt.bubblePadding,
                    ),
                    width:
                        utils.getPixelValue(step.width) || this.opt.bubbleWidth,
            ...
            if (typeof tourSpecificRenderer === 'function') {
                ...
                if (
                    ...
                    typeof winHopscotch.templates[tourSpecificRenderer] !==
                        'function'
                ) {
                    throw new Error(
            ...
            el.style.zIndex =
                typeof step.zindex === 'number' ? step.zindex : '';
        ...
        _handleBubbleClick: function (evt) {
            ...
            if (action === 'cta') {
                if (!this.opt.isTourBubble) {
                    ...
                    winHopscotch
                        .getCalloutManager()
                        .removeCallout(this.currStep.id);
                }
                ...
                if (this.opt.isTourBubble) {
                    var currStepNum = winHopscotch.getCurrStepNum(),
                        currTour = winHopscotch.getCurrTour(),
                        doEndCallback =
                            currStepNum === currTour.steps.length - 1;
    ...
    Hopscotch = function (initOptions) {
        var self = this, // for targetClickNextFn
            ...
            adjustWindowScroll = function (cb) {
                var bubble = getBubble(),
                    ...
                    bubbleBottom =
                        bubbleTop + utils.getPixelValue(bubbleEl.offsetHeight),
                    ...
                    targetTop =
                        bubbleTop < targetElTop ? bubbleTop : targetElTop,
                    // The lower of the two: bubble or target
                    targetBottom =
                        bubbleBottom > targetElBottom
                            ? bubbleBottom
                            : targetElBottom,
                    ...
                    // Use my crummy setInterval scroll solution if we're using plain, vanilla Javascript.
                        ...
                        scrollTimeoutFn = function () {
                            var scrollTop = utils.getScrollTop(),
                                scrollTarget =
                                    scrollTop + direction * scrollIncr;
            ...
            changeStep = function (doCallbacks, direction) {
                ...
                if (direction > 0) {
                    ...
                    wasMultiPage =
                        currStepNum > 0 &&
                        currTour.steps[currStepNum - 1].multipage;
                }
                ...
                changeStepCb = function (stepNum) {
                    ...
                    doShowFollowingStep = utils.valOrDefault(
                        doShowFollowingStep,
                        true,
                    );
        ...
        this.startTour = function (tour, stepNum) {
            ...
            if (
                ...
                if (cookieSkippedSteps.length > 0) {
                    for (
                        var i = 0, len = cookieSkippedSteps.length;
                        i < len;
                        i++
                    ) {
            ...
            findStartingStep(currStepNum, skippedSteps, function (stepNum) {
                var target =
                    stepNum !== -1 &&
                    utils.getStepTarget(currTour.steps[stepNum]);
        ...
        _configure = function (options, isTourOptions) {
            ...
            for (i = 0, len = events.length; i < len; ++i) {
                ...
                eventPropName =
                    'on' +
                    events[i].charAt(0).toUpperCase() +
                    events[i].substring(1);
            ...
            with (obj) {
                ...
                if (step.title !== '') {
                    __p +=
                        ...
                        ((__t = optEscape(step.title, tour.unsafe)) == null
                            ? ''
                            : __t) +
                        '</h3>';
                }
                ...
                if (step.content !== '') {
                    __p +=
                        ...
                        ((__t = optEscape(step.content, tour.unsafe)) == null
                            ? ''
                            : __t) +
                        '</div>';
                }
