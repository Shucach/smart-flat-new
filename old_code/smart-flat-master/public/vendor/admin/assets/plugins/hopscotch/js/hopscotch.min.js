...
!(function (a, b) {
    ...
    var Hopscotch,
        ...
        rtlMatches = { left: 'right', right: 'left' };
    try {
        typeof window.sessionStorage !== undefinedStr &&
            ((hasSessionStorage = !0),
    ...
    return (
        ...
        (utils = {
            ...
            invokeCallbackArrayHelper: function (a) {
                ...
                return Array.isArray(a) &&
                    ((b = helpers[a[0]]), 'function' == typeof b)
            ...
            invokeCallbackArray: function (a) {
                ...
                if (Array.isArray(a)) {
                    if ('string' == typeof a[0])
                        return utils.invokeCallbackArrayHelper(a);
                    for (b = 0, c = a.length; c > b; ++b)
                        utils.invokeCallback(a[b]);
                }
            },
            invokeCallback: function (a) {
                return 'function' == typeof a
                    ? a()
                    : 'string' == typeof a && helpers[a]
                      ? helpers[a]()
                      : utils.invokeCallbackArray(a);
            },
            ...
            getScrollTop: function () {
                var a;
                return (a =
                    typeof window.pageYOffset !== undefinedStr
                        ? window.pageYOffset
            ...
            getScrollLeft: function () {
                var a;
                return (a =
                    typeof window.pageXOffset !== undefinedStr
                        ? window.pageXOffset
            ...
            getStepTargetHelper: function (a) {
                ...
                if (Sizzle)
                    return ((b = new Sizzle(a)), b.length ? b[0] : null);
            ...
            setState: function (a, b, c) {
                ...
                if (hasSessionStorage && isStorageWritable)
                    ...
                    (hasSessionStorage && sessionStorage.removeItem(a),
                        c &&
                            ((d = new Date()),
            ...
            getState: function (a) {
                ...
                if (hasSessionStorage && (d = sessionStorage.getItem(a)))
                    return d;
        ...
        (HopscotchBubble.prototype = {
            ...
            setPosition: function (a) {
                var b,
                    ...
                    g,
                    h,
                    i = utils.getStepTarget(a),
                    j = this.element,
                    k = this.arrowEl,
                    l = a.isRtl ? 'right' : 'left';
                if (
                    (utils.flipPlacement(a),
                    utils.normalizePlacement(a),
                    (c = j.offsetWidth),
                    (b = j.offsetHeight),
                    utils.removeClass(
                        j,
                    ...
                    (h = a.isRtl ? d.right - c : d.left),
                    'top' === a.placement)
                )
                    ((e = d.top - b - this.opt.arrowWidth), (f = h));
                else if ('bottom' === a.placement)
                    ((e = d.bottom + this.opt.arrowWidth), (f = h));
                ...
                ((g =
                    'center' !== a.arrowOffset
                        ? utils.getPixelValue(a.arrowOffset)
                        : a.arrowOffset),
                    g
                        ? 'top' === a.placement || 'bottom' === a.placement
                            ? ((k.style.top = ''),
                              'center' === g
                                  ? (k.style[l] =
                                        Math.floor(c / 2 - k.offsetWidth / 2) +
                                        'px')
                                  : (k.style[l] = g + 'px'))
                            : ('left' === a.placement ||
                                  'right' === a.placement) &&
                              ...
                              'center' === g
                                  ? (k.style.top =
                                        Math.floor(b / 2 - k.offsetHeight / 2) +
                                        'px')
                                  : (k.style.top = g + 'px'))
                        : ((k.style.top = ''), (k.style[l] = '')),
                    'center' === a.xOffset
                        ? (f = d.left + i.offsetWidth / 2 - c / 2)
                        : (f += utils.getPixelValue(a.xOffset)),
                    'center' === a.yOffset
                        ? (e = d.top + i.offsetHeight / 2 - b / 2)
                        : (e += utils.getPixelValue(a.yOffset)),
                    a.fixedElement ||
                        ((e += utils.getScrollTop()),
                        (f += utils.getScrollLeft())),
                    (j.style.position = a.fixedElement ? 'fixed' : 'absolute'),
                    (j.style.top = e + 'px'),
                    (j.style.left = f + 'px'));
            },
            render: function (a, b, c) {
                ...
                if (
                    ...
                    this.opt.isTourBubble
                        ? ((g = winHopscotch.getCurrTour()),
                          g &&
                              ((e = g.customData),
                              (d = g.customRenderer),
                              (a.isRtl = a.hasOwnProperty('isRtl')
                                  ? a.isRtl
                                  : g.hasOwnProperty('isRtl')
                                    ? g.isRtl
                                    : this.opt.isRtl),
                              (f = g.unsafe),
                              Array.isArray(g.steps) &&
                                  ((h = g.steps.length),
                                  (j = this._getStepI18nNum(
                                      this._getStepNum(h - 1),
                                  )),
                                  (l =
                                      this._getStepNum(b) ===
                                      this._getStepNum(h - 1)))))
                        : ((e = a.customData),
                          ...
                          (a.isRtl = a.hasOwnProperty('isRtl')
                              ? a.isRtl
                              : this.opt.isRtl)),
                    (k = utils.getI18NString(
                        l ? 'doneBtn' : a.showSkip ? 'skipBtn' : 'nextBtn',
                    )),
                    utils.flipPlacement(a),
                    utils.normalizePlacement(a),
                    ...
                    if (
                        ...
                        'function' != typeof winHopscotch.templates[d]
                    )
                        throw new Error(
                    ...
                    if (
                        !winHopscotch.templates ||
                        'function' !=
                            typeof winHopscotch.templates[templateToUse]
                    )
                        throw new Error(
                            'Bubble rendering failed - template "' +
                                templateToUse +
                ...
                for (
                    children = n.children, numChildren = children.length, i = 0;
                    i < numChildren;
                    i++
                )
                    ((node = children[i]),
                        utils.hasClass(node, 'hopscotch-arrow') &&
                            (this.arrowEl = node));
                return (
                    (n.style.zIndex =
            ...
            hide: function (a) {
                var b = this.element;
                return (
                    (a = utils.valOrDefault(a, !0)),
                    (b.style.top = ''),
                    (b.style.left = ''),
                    a
                        ? (utils.addClass(b, 'hide'),
                          utils.removeClass(b, 'invisible'))
                        : (utils.removeClass(b, 'hide'),
                          utils.addClass(b, 'invisible')),
                    utils.removeClass(
                        b,
            ...
            destroy: function () {
                ...
                (a && a.parentNode.removeChild(a),
                    utils.removeEvtListener(a, 'click', this.clickCb));
            },
            _handleBubbleClick: function (a) {
                function b(c) {
                    return c === a.currentTarget
                        ? null
                        : utils.hasClass(c, 'hopscotch-cta')
                          ? 'cta'
                          : utils.hasClass(c, 'hopscotch-next')
                            ? 'next'
                            : utils.hasClass(c, 'hopscotch-prev')
                              ? 'prev'
                              : utils.hasClass(c, 'hopscotch-close')
                                ? 'close'
                                : b(c.parentElement);
                }
                var c;
            ...
            init: function (a) {
                ...
                ((this.element = f),
                    ...
                    (a = typeof a === undefinedStr ? {} : a),
                    utils.extend(e, a),
                    (this.opt = e),
                    (f.className = 'hopscotch-bubble animated'),
                    e.isTourBubble
                        ? ((d = winHopscotch.getCurrTour()),
                          d && utils.addClass(f, 'tour-' + d.id))
                        : utils.addClass(f, 'hopscotch-callout no-number'),
                    (b = function () {
                        !h &&
                            g.isShowing &&
                            ((h = !0),
                    ...
                    utils.addEvtListener(window, 'resize', b),
                    (this.clickCb = function (a) {
                        g._handleBubbleClick(a);
                    }),
                    utils.addEvtListener(f, 'click', this.clickCb),
                    this.hide(),
                    utils.documentIsReady()
                        ...
                        : (document.addEventListener
                          ...
                          utils.addEvtListener(window, 'load', c)));
            },
        }),
        (HopscotchCalloutManager = function () {
            ...
            ((this.createCallout = function (c) {
                ...
                if (!utils.getStepTarget(c))
                    throw new Error(
                        "Must specify existing target element via 'target' option.",
                    );
                return (
                    (c.showNextButton = c.showPrevButton = !1),
                    (c.isTourBubble = !1),
                    (d = new HopscotchBubble(c)),
                    (a[c.id] = d),
                    (b[c.id] = c),
                    d.render(c, null, function () {
        ...
        (Hopscotch = function (a) {
            var b,
                ...
                m = function (a) {
                    return (
                        (b && b.element && b.element.parentNode) ||
                            (b = new HopscotchBubble(d)),
                        a &&
                            utils.extend(b.opt, {
                ...
                o = function (a) {
                    return 'undefined' == typeof d
                        ? defaultOpts[a]
                        : utils.valOrDefault(d[a], defaultOpts[a]);
                },
                p = function () {
                    var a;
                    return (a =
                        !e || 0 > f || f >= e.steps.length ? null : e.steps[f]);
                },
                q = function () {
                    j.nextStep();
                },
                ...
                s = function (a, b) {
                    var c, d, g;
                    f + a >= 0 && f + a < e.steps.length
                        ? ((f += a),
                          (d = p()),
                          (g = function () {
                              ((c = utils.getStepTarget(d)),
                                  c
                                      ? (k[f] && delete k[f], b(f))
                                      : ((k[f] = !0),
                          ...
                          d.delay ? setTimeout(g, d.delay) : g())
                        : b(-1);
                },
                t = function (a, b) {
                    var c,
                    ...
                    if (
                        ...
                        (h = function (c) {
                            ...
                            if (
                                ...
                                if (g) return void x();
                                ((e = utils.valOrDefault(e, !0)),
                                    e ? this.showStep(c) : this.endTour(!1));
                            }
                        }),
                        !g && o('skipIfNoElement'))
                    )
                        ...
                        if (
                            ((f += b), (c = p()), !utils.getStepTarget(c) && !g)
                        )
                            return (
                                utils.invokeEventCallbacks('error'),
                                this.endTour(!0, !1)
                ...
                u = function (a) {
                    ...
                    return (
                        i.call(this, e, !0),
                        (c = utils.getState(o('cookieName'))),
                        c &&
                            ((d = c.split(':')),
                            (g = d[0]),
                            (h = d[1]),
                            d.length > 2 && (l = d[2].split(',')),
                            (h = parseInt(h, 10))),
                        this
                    );
                },
                ...
                w = function (a) {
                    function b() {
                        (d.show(),
                            utils.invokeEventCallbacks('show', c.onShow));
                    }
                    var c = e.steps[a],
                        d = m(),
                    ...
                    (f !== a &&
                        ...
                        d.render(c, a, function (a) {
                            (a ? r(b) : b(),
                                c.nextOnTargetClick &&
                                    utils.addEvtListener(g, 'click', q));
                        }),
                        x());
                },
                x = function () {
                    ...
                    (b && b.length > 0 && (a += ':' + b.join(',')),
                        utils.setState(o('cookieName'), a, 1));
                },
                y = function (a) {
                    a && this.configure(a);
                };
            ((this.getCalloutManager = function () {
                return (
                    typeof c === undefinedStr &&
                        (c = new HopscotchCalloutManager()),
                    c
                );
            }),
                (this.startTour = function (a, b) {
                    ...
                    if (!e) {
                        ...
                        if (!a.id || !validIdRegEx.test(a.id))
                            throw new Error(
                    ...
                    if (!utils.documentIsReady())
                        return ((waitingToStart = !0), this);
                    if (
                        'undefined' == typeof d &&
                        e.id === g &&
                        typeof h !== undefinedStr
                    ) {
                        if (((d = h), l.length > 0))
                ...
                (this.endTour = function (a, b) {
                    ...
                    return (
                        ...
                        (h = void 0),
                        d.hide(),
                        a && utils.clearState(o('cookieName')),
                        this.isActive &&
                            ((this.isActive = !1),
                            e && b && utils.invokeEventCallbacks('end')),
                ...
                (this.listen = function (a, b, c) {
                    return (
                        a && callbacks[a].push({ cb: b, fromTour: c }), this
                    );
                }),
                ...
                (i = function (a, b) {
                    ...
                    for (
                        d || this.resetDefaultOptions(),
                            utils.extend(d, a),
                            a && utils.extend(customI18N, a.i18n),
                            f = 0,
                            g = h.length;
                        g > f;
                        ++f
                        ...
                        ((e =
                            'on' +
                            h[f].charAt(0).toUpperCase() +
                            h[f].substring(1)),
                            a[e] && this.listen(h[f], a[e], b));
                    return ((c = m(!0)), this);
                }),
                ...
                (this.setRenderer = function (a) {
                    ...
                    return (
                        'string' === b
                            ? ((templateToUse = a), (customRenderer = void 0))
                            : 'function' === b && (customRenderer = a),
                        this
                    );
                }),
                ...
                (this.templates.bubble_default = function (obj) {
                    ...
                    with (obj)
                        ((__p +=
                            ...
                            (null == (__t = step.width) ? '' : __t) +
                            'px; padding: ' +
                            (null == (__t = step.padding) ? '' : __t) +
                            'px;">\n  '),
                            tour.isTour &&
                                (__p +=
                                    '<span class="hopscotch-bubble-number">' +
                                    (null == (__t = i18n.stepNum) ? '' : __t) +
                                    '</span>'),
                            (__p +=
                            ...
                            '' !== step.title &&
                                (__p +=
                                    ...
                                    (null ==
                                    (__t = optEscape(step.title, tour.unsafe))
                                        ? ''
                                        : __t) +
                                    '</h3>'),
                            (__p += '\n    '),
                            '' !== step.content &&
                                (__p +=
                                    ...
                                    (null ==
                                    (__t = optEscape(step.content, tour.unsafe))
                                        ? ''
                                        : __t) +
                                    '</div>'),
                            (__p +=
                            ...
                            buttons.showNext &&
                                (__p +=
                                    ...
                                    (null == (__t = i18n.nextBtn) ? '' : __t) +
                                    '</button>'),
                            (__p += '\n  </div>\n  '),
                            buttons.showClose &&
                                (__p +=
                                    '<button class="hopscotch-bubble-close hopscotch-close">' +
                                    (null == (__t = i18n.closeTooltip)
                                        ? ''
                                        : __t) +
                                    '</button>'),
                            (__p +=
