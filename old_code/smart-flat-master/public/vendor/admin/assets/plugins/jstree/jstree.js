                    ...
                    .on(
                        ...
                        $.proxy(function (e, data) {
                            ...
                            if (s.indexOf('down') !== -1) {
                                ...
                                for (
                                    i = 0, j = obj.children_d.length;
                                    i < j;
                                    i++
                                ) {
                                    tmp = m[obj.children_d[i]];
                                    tmp.state[t ? 'selected' : 'checked'] =
                                        true;
                                    if (
                                        tmp &&
                                        tmp.original &&
                            ...
                            if (s.indexOf('down') !== -1 && dom.length) {
                                dom.find('.jstree-anchor')
                                    .addClass(
                                        t ? 'jstree-clicked' : 'jstree-checked',
                                    )
                                    .parent()
            ...
            this.element
                ...
                .on('touchmove.vakata.jstree', function (e) {
                    if (
                        ...
                        e.originalEvent.changedTouches &&
                        e.originalEvent.changedTouches[0] &&
                        (Math.abs(ex - e.pageX) > 50 ||
                            Math.abs(ey - e.pageY) > 50)
                    ) {
                        clearTimeout(cto);
                    }
                })
            ...
            switch (chk) {
                ...
                case 'rename_node':
                    i =
                        $.inArray(n, c) === -1 ||
                        (obj.text &&
                            obj.text[s ? 'toString' : 'toLowerCase']() === n);
                    if (!i) {
                        this._data.core.last_error = {
                            error: 'check',
                            plugin: 'unique',
