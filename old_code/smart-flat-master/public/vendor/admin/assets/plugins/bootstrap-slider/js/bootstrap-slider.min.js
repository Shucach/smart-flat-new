        ...
        (function (a) {
            function e(b, c) {
                ...
                if (
                    ...
                    g[this.options.scale] &&
                        (this.options.scale = g[this.options.scale]),
                    p === !0 &&
                        (this._removeClass(
                            this.sliderElem,
                            'slider-horizontal',
                ...
                (d.prototype = {
                        ...
                        if (
                            ...
                            if (this.tickLabelContainer) {
                                ...
                                if (0 === this.options.ticks_positions.length)
                                    ('vertical' !== this.options.orientation &&
                                        (this.tickLabelContainer.style[c] =
                                            -d / 2 + 'px'),
                                        (e =
                                            this.tickLabelContainer
                                                .offsetHeight));
                                    ...
                                    for (
                                        ...
                                        this.tickLabelContainer.childNodes[f]
                                            .offsetHeight > e &&
                                            (e =
                                                this.tickLabelContainer
                                                    .childNodes[f]
                            ...
                            for (
                                ...
                                (this.options.reversed && (g = 100 - g),
                                    (this.ticks[f].style[this.stylePos] =
                                        g + '%'),
                                    this._removeClass(
                                        this.ticks[f],
                                        'in-selection',
                                    ...
                                    this.tickLabels[f] &&
                                        ...
                                        void 0 !==
                                            ...
                                            ? ((this.tickLabels[
                                              ...
                                              (this.tickLabels[f].style[
                                                  this.stylePos
                                              ] = g + '%'),
                                              (this.tickLabels[f].style[c] =
                                                  -d / 2 + 'px'))
                                            : 'vertical' ===
                                                  this.options.orientation &&
                                              ((this.tickLabels[
                    ...
                    _keydown: function (a, b) {
                        ...
                        if (c) {
                            ...
                            var f =
                                this._state.value[a] + c * this.options.step;
                            return (
                                this.options.range &&
                                    (f = [
                    ...
                    _validateArray: function (a) {
                        for (var b = 0; b < a.length; b++) {
                            ...
                            if ('number' != typeof c)
                                throw new Error(
                                    f.formatInvalidInputErrorMsg(c),
                                );
                        }
                    },
