    ...
    'function' === typeof define && define.amd
        ...
        : 'object' === typeof exports
          ? (module.exports = function (c, a) {
                c || (c = window);
                if (!a || !a.fn.dataTable)
                    a = require('datatables.net')(c, a).$;
                a.fn.dataTable.Buttons ||
                    require('datatables.net-buttons')(c, a);
        ...
        action: function (a, b, i, e) {
            ...
            d('style, link').each(function () {
                ...
                'link' === b.nodeName.toLowerCase() &&
                    ...
                    (c = f.host),
                    -1 === c.indexOf('/') &&
                        0 !== f.pathname.indexOf('/') &&
                        (c += '/'),
                    (b.href = f.protocol + '//' + c + f.pathname + f.search));
                k = a + b.outerHTML;
            });
            d(g.document.head).html(k);
            d(g.document.body).html(
                '<h1>' + a + '</h1><div>' + e.message + '</div>' + b,
            );
