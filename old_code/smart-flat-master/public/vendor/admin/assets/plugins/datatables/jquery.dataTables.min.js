    ...
    var S = function (g) {
        ...
        function L(a, b, c, e) {
            ...
            for (var h = a.aoColumns, i = 0, j = h.length; i < j; i++)
                (c && Ja(a, d, i, y(a, d, i)), (h[i].sType = null));
        ...
        function Na(a, b) {
            ...
            if (c) {
                ...
                e.DT_RowClass &&
                    ...
                    (b.__rowc = b.__rowc ? Oa(b.__rowc.concat(d)) : d),
                    g(c)
                    ...
                    for (b = h[e].length; f < b; f++)
                        if (((n = j = 1), i[e][f] === k)) {
                            ...
                            for (
                                i[e][f] = 1;
                                h[e + j] !== k &&
                                h[e][f].cell == h[e + j][f].cell;
                            )
                                ((i[e + j][f] = 1), j++);
                            for (
                                ;
                                h[e][f + n] !== k &&
                                h[e][f].cell == h[e][f + n].cell;
                            ) {
        ...
        function xb(a, b, c, e, d, f) {
            if ('' !== b)
                for (
                    var h = a.aiDisplay, e = Ra(b, e, d, f), d = h.length - 1;
                    0 <= d;
                    d--
                )
        ...
        function ha(a) {
            ...
            if (a.bInitialised) {
                ...
                for (c = d.length; b < c; b++)
                    ((f = d[b]), f.sWidth && (f.nTh.style.width = u(f.sWidth)));
                w(a, null, 'preInit', [a]);
                R(a);
                d = z(a);
                if ('ssp' != d || h)
            ...
            for (a = 0; a < n.length; a++) {
                ...
                for (c = f.length; b < c; b++)
                    ((h = f[b]),
                        (i = d[h].sType || 'string'),
                        n[a]._idx === k &&
                            (n[a]._idx = g.inArray(n[a][1], d[h].asSorting)),
                        e.push({
                            src: j,
                            col: h,
                            dir: n[a][1],
        ...
        m = function (a) {
            ...
            this.each(function () {
                ...
                if ('table' != this.nodeName.toLowerCase())
                    ...
                    d.aLengthMenu &&
                        !d.iDisplayLength &&
                        (d.iDisplayLength = g.isArray(d.aLengthMenu[0])
                            ? d.aLengthMenu[0][0]
                            : d.aLengthMenu[0]);
                    d = Mb(g.extend(!0, {}, l), d);
                    F(
                    ...
                    j = o.oClasses;
                    d.bJQueryUI
                        ? (g.extend(j, m.ext.oJUIClasses, d.oClasses),
                          d.sDom === l.sDom &&
                              'lfrtip' === l.sDom &&
                              (o.sDom = '<"H"lfr>t<"F"ip>'),
                          o.renderer)
                            ...
                            : (o.renderer = 'jqueryui')
                        : g.extend(j, m.ext.classes, d.oClasses);
                    r.addClass(j.sTable);
                    if ('' !== o.oScroll.sX || '' !== o.oScroll.sY)
                        o.oScroll.iBarWidth = Ib();
                    o.iInitDisplayStart === k &&
                        ((o.iInitDisplayStart = d.iDisplayStart),
                        (o._iDisplayStart = d.iDisplayStart));
                    null !== d.iDeferLoading &&
                        ((o.bDeferLoading = !0),
                        (h = g.isArray(d.iDeferLoading)),
                        (o._iRecordsDisplay = h
                            ? d.iDeferLoading[0]
                            : d.iDeferLoading),
                        (o._iRecordsTotal = h
                            ? d.iDeferLoading[1]
                    ...
                    -1 !==
                        ...
                        (g('tbody tr', this).removeClass(h.join(' ')),
                        (o.asDestroyStripes = h.slice()));
                    q = [];
        ...
        t.register = p = function (a, b) {
            if (g.isArray(a))
                ...
                for (
                    var d = a.split('.'), f = Ub, h, i, c = 0, e = d.length;
                    c < e;
                    c++
                ) {
                    h = (i = -1 !== d[c].indexOf('()'))
        ...
        p('destroy()', function (a) {
            ...
            return this.iterator('table', function (b) {
                ...
                !a &&
                    c &&
                    (c.insertBefore(d, b.nTableReinsertBefore),
