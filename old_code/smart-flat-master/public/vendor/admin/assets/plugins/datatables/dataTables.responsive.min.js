...
(function (c) {
    ...
    var n = c.fn.dataTable,
        j = function (a, b) {
            ...
            this.s = { dt: new n.Api(a), columns: [], current: [] };
            this.s.dt.settings()[0].responsive ||
                (b &&
                    'string' === typeof b.details &&
    ...
    c.extend(j.prototype, {
            ...
            var a = this,
                ...
                e = d
                    ...
                    .map(function (a) {
                        ...
                        a === p &&
                            (a =
                                c(b.header).data('priority') !== p
                                    ? 1 * c(b.header).data('priority')
                                    : 1e4);
                        return {
                            className: e,
                            includeIn: [],
        ...
        _detailsDisplay: function (a, b) {
            var d = this,
                ...
                f = this.c.details.display(a, b, function () {
                    return d.c.details.renderer(e, a[0], d._detailsObj(a[0]));
                });
            (!0 === f || !1 === f) &&
        ...
        _detailsInit: function () {
            ...
            c(b.table().body())
                .on('mousedown.dtr', d, function (a) {
                    a.preventDefault();
                })
                .on('click.dtr', d, function () {
                    if (
            ...
            return function (b, d, e) {
                if (d) c('div.dtr-modal-content').empty().append(e());
                    ...
                    a &&
                        a.header &&
                        h
                            .find('div.dtr-modal-content')
                            .prepend('<h2>' + a.header(b) + '</h2>');
