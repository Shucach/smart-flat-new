...
(function (e) {
    ...
    e.extend(l.prototype, {
        ...
        active: function (a, b) {
            this._indexToButton(a).node.toggleClass(
        ...
        removePrep: function (a) {
            ...
            if ('number' === typeof a || -1 === a.indexOf('-'))
                ((b = this.s.buttons[1 * a]),
                    b.conf.destroy &&
                        b.conf.destroy.call(c.button(a), c, b, b.conf),
                    b.node.remove(),
        ...
        text: function (a, b) {
            var c = this._indexToButton(a),
                ...
                d =
                    'string' === typeof a && -1 !== a.indexOf('-') && d && d.tag
                        ? d.tag
                    ...
                    if (e.isArray(h)) this._buildButtons(h, b, c);
                        ...
                        if (i) {
                            ...
                            h.buttons &&
                                ...
                                (h._collection = e('<' + i.tag + '/>').addClass(
                                    i.className,
                                )),
                                this._buildButtons(
                                    h.buttons,
        ...
        _buildButton: function (a, b) {
            ...
            var i = e('<' + c.tag + '/>')
                ...
                .on('click.dtb', function (b) {
                    b.preventDefault();
                    !i.hasClass(c.disabled) &&
                        a.action &&
                        a.action.call(g.button(i), b, g, i, a);
                    i.blur();
                })
            ...
            d = (d = this.c.dom.buttonContainer)
                ? e('<' + d.tag + '/>')
                      .addClass(d.className)
                      .append(i)
                : i;
                ...
                i = function (c, d) {
                    if (c.key)
                        if (c.key === a) d.click();
                            ...
                            e.isPlainObject(c.key) &&
                            c.key.key === a &&
                            (!c.key.shiftKey || b.shiftKey)
                        )
    ...
    l.background = function (a, b, c) {
        ...
        a
            ? e('<div/>')
                  ...
                  .appendTo('body')
                  .fadeIn(c)
            : e('body > div.' + b).fadeOut(c, function () {
                  e(this).remove();
              });
    };
                ...
                d = function (a, b) {
                    ...
                    e.each(b.s.subButtons, function (a, b) {
                        e.each(b, function (a, b) {
                            null !== b &&
                                j.push({ node: b.node[0], name: b.name });
                        });
                    });
                    ...
                    if (e.isArray(a) || a instanceof e) {
                        ...
                        for (g = j.length; f < g; f++)
                            c.push({ inst: b, idx: b.toIndex(j[f].node) });
                        ...
                        'object' === typeof a &&
                            ...
                            ((g = e.inArray(a, f)),
                            -1 !== g &&
                                c.push({ inst: b, idx: b.toIndex(f[g]) }));
                },
                f = 0,
                g = a.length;
            f < g;
        ...
        collection: {
            ...
            action: function (a, b, c, d) {
                var a = c.offset(),
                    ...
                    f = !1;
                e('div.dt-button-background').length &&
                    ((f = e('div.dt-button-collection').offset()),
                    e(o).trigger('click.dtb-collection'));
                d._collection
                ...
                f && 'absolute' === g
                    ? d._collection.css({ top: f.top + 5, left: f.left + 5 })
                    : 'absolute' === g
                      ? (d._collection.css({
                            top: a.top + c.outerHeight(),
                            left: a.left,
                        }),
                        (c = a.left + d._collection.outerWidth()),
                        (b = b.offset().left + b.width()),
                        c > b && d._collection.css('left', a.left - (c - b)))
                      : ((a = d._collection.height() / 2),
                        a > e(n).height() / 2 && (a = e(n).height() / 2),
                        d._collection.css('marginTop', -1 * a));
                    ...
                    e('body').on('click.dtb-collection', function (a) {
                        if (
                            !e(a.target)
                                .parents()
                                .andSelf()
                                .filter(d._collection).length
                        ) {
                            d._collection.fadeOut(d.fade, function () {
                                d._collection.detach();
                            });
                            e('div.dt-button-background').off(
                                'click.dtb-collection',
                            );
            ...
            for (
                var b = new j.Api(this.context[0]),
                    ...
                    a = b
                        ...
                        .indexes()
                        .map(function (a) {
                            return c.format.header(
                                b.column(a).header().innerHTML,
                                a,
                            );
                        })
                        .toArray(),
                    f = b.table().footer()
                        ? b
                              ...
                              .toArray()
                        : null,
                    g = b.rows(c.rows, c.modifier).indexes().toArray(),
                    g = b.cells(g, c.columns).render(c.orthogonal).toArray(),
                    h = a.length,
                    i = 0 < h ? g.length / h : 0,
                    k = Array(i),
                    l = 0,
                ...
                for (var o = Array(h), n = 0; n < h; n++)
                    ((o[n] = c.format.body(g[l], n, m)), l++);
                k[m] = o;
            }
