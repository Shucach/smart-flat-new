    ...
    if (
        ...
        var v = d.document,
            ...
            r = function (a) {
                var b = function () {
                    'string' === typeof a
                        ? (d.URL || d.webkitURL || d).revokeObjectURL(a)
                        : a.remove();
                };
            ...
            A = function (a, b) {
                ...
                if (D)
                    ...
                    d.chrome &&
                        ...
                        ((j = a.slice || a.webkitSlice),
                        (a = j.call(a, 0, a.size, 'application/octet-stream')),
                        (x = !0));
                ...
                var e = u(b),
                    ...
                    i = function (a) {
                        for (var b = '', c = 0, e = a.length; c < e; c++)
                            (0 < c && (b += h),
                                (b += d
                                    ? d + ('' + a[c]).replace(f, g + d) + d
                                    : a[c]));
                        return b;
                    },
                    n = b.header ? i(c.header) + e : '',
                    j = b.footer ? e + i(c.footer) : '',
                    l = [],
                    m = 0,
                    o = c.body.length;
                m < o;
