...
(function (d) {
    ...
    d.extend(i.prototype, {
        ...
        _constructor: function () {
            ...
            a.on(
                'column-reorder.dt.dtfc column-visibility.dt.dtfc draw.dt.dtfc',
                function () {
                    b.update();
                },
            );
        ...
        _unsize: function (b) {
            ...
            a &&
                ('footer' === b || ('header' === b && !this.s.autoWidth)) &&
                d('th, td', a).css('width', '');
        },
        _horizontal: function (b, a) {
            ...
            e.floating &&
                f[b] !== a &&
                (e.floating.css('left', c.left - a), (f[b] = a));
        },
        _modeChange: function (b, a, e) {
            ...
            if ('in-place' === b) {
                if (
                    ...
                    this._unsize(a),
                    c.host.append(
                        'header' === a ? this.dom.thead : this.dom.tfoot,
                    ),
                    c.floating)
                )
