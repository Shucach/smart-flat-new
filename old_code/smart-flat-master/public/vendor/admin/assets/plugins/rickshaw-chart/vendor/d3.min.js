(function () {
                  ...
                  Math.floor(
                      Math.log(
                          a +
                              Math.pow(
                                  10,
                                  1 + Math.floor(Math.log(a) / Math.LN10) - b,
                              ),
                      ) / Math.LN10,
                  )
                : 1)
    ...
    function bh(a, b) {
        function f() {
            ...
            ((c.lastIndex = 0),
                c.test(e) ||
                    ((e = m(e + ' ' + a)),
                    d ? (b.baseVal = e) : (this.className = e)));
        }
        function g() {
        ...
        if (arguments.length < 2) {
            ...
            var e = d.className;
            return (
                (c.lastIndex = 0), c.test(e.baseVal != null ? e.baseVal : e)
            );
        }
                ...
                function (g) {
                    return (
                        a.each(function (h, i, j) {
                            ...
                            function r() {
                                return (
                                    --o.count || delete l.__transition__, 1
                                );
                            }
                            var k = [],
                                l = this,
    ...
    function bz() {
        ...
        var d = bA() - b;
        d > 24
            ? (isFinite(d) && (clearTimeout(by), (by = setTimeout(bz, d))),
              (bx = 0))
            : ((bx = 1), bB(bz));
    }
    function bA() {
    ...
    function bR(a, b) {
        return d3.format(
            ',.' +
                Math.max(
                    0,
                    -Math.floor(Math.log(bP(a, b)[2]) / Math.LN10 + 0.01),
                ) +
                'f',
        );
    }
    ...
    function b$(a, b) {
        ...
        return (
            ...
            (f.rangeRoundBands = function (c, h) {
                ...
                return (
                    (d = g(
                        i + Math.round((j - i - (a.length - h) * k) / 2),
                        k,
                    )),
                    (e = Math.round(k * (1 - h))),
    ...
    function ct(a, b) {
        return a.length < 4
            ? cq(a)
            : a[1] + cw(a.slice(1, a.length - 1), cx(a, b));
    }
    function cu(a, b) {
        return a.length < 3
            ? cq(a)
            : a[0] +
                  cw(
                      (a.push(a[0]), a),
                      cx([a[a.length - 2]].concat(a, [a[1]]), b),
                  );
    }
    function cv(a, b, c) {
    ...
    ((d3.functor = function (a) {
        ...
        (d3.zip = function () {
            ...
            for (
                var a = -1, b = d3.min(arguments, k), c = new Array(b);
                ++a < b;
            )
        ...
        (d3.nest = function () {
            function f(c, g) {
                ...
                var h = -1,
                    ...
                    m = {};
                while (++h < i)
                    (k = j((l = c[h]))) in m ? m[k].push(l) : (m[k] = [l]);
    ...
    var q =
        ...
        r = {
            ...
            r: function (a, b) {
                return d3
                    .round(a, (b = s(a, b)))
                    .toFixed(Math.max(0, Math.min(20, b)));
            },
        },
        v = [
            'y',
    ...
    ((d3.ease = function (a) {
        ...
        return B(
            A[d](z[c].apply(null, Array.prototype.slice.call(arguments, 1))),
        );
    }),
        (d3.event = null),
    ...
    ((d3.selection = function () {
        ...
        (bd.selectAll = function (a) {
            ...
            for (var f = -1, g = this.length; ++f < g;)
                for (var h = this[f], i = -1, j = h.length; ++i < j;)
                    if ((e = h[i]))
                        (b.push((c = d(a.call(e, e.__data__, i)))),
                            (c.parentNode = e));
            return ba(b);
        }),
        (bd.attr = function (a, b) {
            ...
            if (arguments.length < 2) {
                var c = this.node();
                return a.local
                    ? c.getAttributeNS(a.space, a.local)
                    : c.getAttribute(a);
            }
            return this.each(
                b == null
    ...
    ((bd.style = function (a, b, c) {
        ...
        (bd.data = function (a, b) {
            ...
            if (typeof a == 'function')
                while (++g < h)
                    f((i = this[g]), a.call(i, i.parentNode.__data__, g));
        ...
        (bd.sort = function (a) {
            ...
            for (var b = 0, c = this.length; b < c; b++)
                for (
                    ...
                    var h = d[e];
                    h &&
                        (g && g.parentNode.insertBefore(h, g.nextSibling),
                        (g = h));
                }
            return this;
        }),
        ...
        (bm.select = function (a) {
            ...
            for (var h = -1, i = this.length; ++h < i;) {
                ...
                for (var j = -1, k = f.length; ++j < k;)
                    (g = f[j])
                        ? (c.push(
                              (e[j] = d = a.call(f.parentNode, g.__data__, j)),
                          ),
    ...
    ((br.call = bd.call),
        ...
        (br.attrTween = function (a, b) {
            ...
            function e(a, d) {
                var e = b.call(
                    ...
                    a,
                    d,
                    this.getAttributeNS(c.space, c.local),
                );
                return e === bo
        ...
        (br.text = function (a) {
            return this.tween('text', function (b, c) {
                this.textContent =
                    typeof a == 'function' ? a.call(this, b, c) : a;
            });
        }),
        (br.remove = function () {
    ...
    ((d3.svg.touches = function (a, b) {
        ...
        (d3.svg.symbol = function () {
            function c(c, d) {
                return (c$[a.call(this, c, d)] || c$.circle)(
                    b.call(this, c, d),
                );
            }
            var a = cZ,
