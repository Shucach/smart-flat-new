(function (root, factory) {
        ...
        if (
            ...
            (function (view) {
                ...
                var classListProp = 'classList',
                    protoProp = 'prototype',
                    elemCtrProto = (view.HTMLElement || view.Element)[
                        protoProp
                    ],
                    objCtr = Object,
                    strTrim =
    ...
    Rickshaw.Graph = function (args) {
        ...
        this.validateSeries = function (series) {
            ...
            series.forEach(function (s) {
                ...
                if (!Array.isArray(s.data)) {
                    throw (
                        'series data is not an array: ' + JSON.stringify(s.data)
                    );
                }
                if (s.data.length > 0) {
                    var x = s.data[0].x;
        ...
        this.configure = function (args) {
            ...
            var renderer =
                args.renderer ||
                (this.renderer && this.renderer.name) ||
                'stack';
    ...
    Rickshaw.Fixtures.Time = function () {
        ...
        this.ceil = function (time, unit) {
            ...
            if (unit.name == 'month') {
                ...
                floor =
                    Date.UTC(date.getUTCFullYear(), date.getUTCMonth()) / 1e3;
    ...
    Rickshaw.Color.Palette = function (args) {
        ...
        this.schemes = {};
        this.scheme =
            color.schemes[args.scheme] ||
            args.scheme ||
            color.schemes.colorwheel;
        this.runningIndex = 0;
        ...
        if (args.interpolatedStopCount) {
            ...
            for (i = 0; i < schemeCount; i++) {
                ...
                for (j = 1; j < args.interpolatedStopCount; j++) {
                    scheme.push(
                        generator((1 / args.interpolatedStopCount) * j),
                    );
                }
            }
            ...
            Rickshaw.keys(self.data).forEach(function (time) {
                ...
                annotation.boxes.forEach(function (box) {
                    ...
                    if (box.end) {
                        ...
                        box.rangeElement.style.left =
                            annotationRangeStart + 'px';
                        box.rangeElement.style.width =
    ...
    Rickshaw.Graph.Axis.X = function (args) {
        ...
        this.render = function () {
            ...
            this.graph.vis
                ...
                .call(
                    axis.ticks(this.ticks).tickSubdivide(0).tickSize(gridSize),
                )
                .selectAll('text')
                .each(function () {
        ...
        this._discoverSize = function (element, args) {
            ...
            this.width =
                (args.width || elementWidth || this.graph.width) *
                (1 + berthRate);
    ...
    Rickshaw.Graph.Axis.Y.Scaled = Rickshaw.Class.create(
                        ...
                        if (l === line) {
                            if (
                                ...
                                (line.series.renderer
                                    ? line.series.renderer.unstack
                                    : true)
                            ) {
                                var seriesIndex = self.graph.series.indexOf(
                                    line.series,
                                );
            ...
            l.element.addEventListener(
                ...
                function (e) {
                    ...
                    self.legend.lines.forEach(function (line) {
                        if (
                            l === line &&
                            line.hasOwnProperty('originalIndex')
                        ) {
                            var series = self.graph.series.pop();
                            self.graph.series.splice(
                                line.originalIndex,
                                0,
                                series,
                            );
            ...
            this.graph.series.active().forEach(function (series) {
                ...
                for (var i = approximateIndex; i < data.length - 1;) {
                    ...
                    if (data[i].x <= domainX && data[i + 1].x > domainX) {
                        dataIndex =
                            Math.abs(domainX - data[i].x) <
                            Math.abs(domainX - data[i + 1].x)
                                ? i
                                : i + 1;
                        break;
                    }
                ...
                var distance = Math.sqrt(
                    Math.pow(Math.abs(graph.x(value.x) - eventX), 2) +
                        Math.pow(
                            Math.abs(graph.y(value.y + value.y0) - eventY),
                            2,
                        ),
                );
    ...
    Rickshaw.Graph.RangeSlider.Preview = Rickshaw.Class.create({
        initialize: function (args) {
            ...
            args.width =
                args.width || this.graphs[0].width || this.defaults.width;
            args.height =
                args.height ||
        ...
        configure: function (args) {
            ...
            if ('width' in args || 'height' in args) {
                ...
                this.previews.forEach(function (preview) {
                    ...
                    var width =
                        this.config.width -
                        this.config.frameHandleThickness * 2;
                    preview.setSize({ width: width, height: height });
                    if (this.svg) {
                        var svgHeight =
                            height + this.config.frameHandleThickness * 2;
                        var svgWidth =
                            width + this.config.frameHandleThickness * 2;
        ...
        render: function () {
            ...
            var buildGraph = function (parent, index) {
                ...
                parent.onConfigure(function (args) {
                    delete args.height;
                    args.width =
                        args.width - self.config.frameHandleThickness * 2;
        ...
        _renderFrame: function () {
            ...
            path +=
                ' H ' +
                (this.currentFrame[1] + this.config.frameHandleThickness);
            path += ' v ' + this.previewHeight;
            path +=
                ' H ' +
                (this.currentFrame[0] + this.config.frameHandleThickness);
            ...
            [0.4, 0.6].forEach(
                function (spacing) {
                    path +=
                        ...
                        Math.round(
                            this.currentFrame[0] +
                                this.config.frameHandleThickness * spacing,
                        ) +
                        ' ' +
        ...
        _renderHandles: function () {
            var leftHandle = this.svg
                .selectAll('rect.left_handle')
                .data([null]);
            leftHandle
                .enter()
                .append('rect')
            ...
            var rightHandle = this.svg
                .selectAll('rect.right_handle')
                .data([null]);
            rightHandle
                .enter()
                .append('rect')
        ...
        _renderMiddle: function () {
            var middleHandle = this.svg
                .selectAll('rect.middle_handle')
                .data([null]);
            middleHandle
                .enter()
                .append('rect')
        ...
        _registerMouseEvents: function () {
            ...
            function onMousemove(datum, index) {
                ...
                if (drag.rigid) {
                    minimumFrameWidth =
                        self.frameBeforeDrag[1] - self.frameBeforeDrag[0];
                }
                if (drag.left) {
                    frameAfterDrag[0] = Math.max(
                ...
                if (currentFrameWidth <= minimumFrameWidth) {
                    if (drag.left) {
                        frameAfterDrag[0] =
                            frameAfterDrag[1] - minimumFrameWidth;
                    }
                    if (drag.right) {
                        frameAfterDrag[1] =
                            frameAfterDrag[0] + minimumFrameWidth;
                    }
            ...
            element
                ...
                .on('mousedown', onMousedownLeftHandle);
            element
    ...
    Rickshaw.Graph.Renderer.Bar = Rickshaw.Class.create(
        Rickshaw.Graph.Renderer,
        {
            name: 'bar',
            defaults: function ($super) {
            ...
            barWidth: function (series) {
                ...
                var barWidth =
                    this.graph.x.magnitude(frequentInterval.magnitude) *
                    (1 - this.gapSize);
                return barWidth;
            },
            render: function (args) {
