        ...
        (x = function (t) {
            ...
            return (
                ...
                n.each(t.split(/\W+/), function (t, n) {
                    var o;
                    return (
                        (o = n.toLowerCase().charAt(0)), M[o] ? i.push(o) : e
                    );
                }),
                i
            );
            ...
            return (
                ...
                (t.prototype.show = function (t, i) {
                    ...
                    if (
                        ...
                        (a =
                            this.container.parent().parents(':hidden').length >
                            0),
                ...
                n(i).on(
                    ...
                    function (t) {
                        ...
                        return (
                            (i = n(this).data(C)),
                            i &&
                            (i.options.clickToHide || 'notify-hide' === t.type)
                                ? i.show(!1)
                                : e
                        );
                    },
