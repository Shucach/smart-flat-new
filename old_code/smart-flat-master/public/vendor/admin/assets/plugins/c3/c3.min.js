!(function (a) {
    ...
    ((k.generate = function (a) {
        ...
        (i.updateSvgSize = function () {
            ...
            (a.svg
                .attr('width', a.currentWidth)
                .attr('height', a.currentHeight),
                a.svg
        ...
        (i.trimXDomain = function (a) {
            ...
            return (
                a[0] <= b.orgXDomain[0] &&
                    ((a[1] = +a[1] + (b.orgXDomain[0] - a[0])),
                    (a[0] = b.orgXDomain[0])),
                b.orgXDomain[1] <= a[1] &&
                    ((a[0] = +a[0] - (a[1] - b.orgXDomain[1])),
                    (a[1] = b.orgXDomain[1])),
                a
            );
        }),
        ...
        (i.addName = function (a) {
            var b,
                c = this;
            return (
                a && ((b = c.config.data_names[a.id]), (a.name = b ? b : a.id)),
                a
            );
        }),
            ...
            a.data
                ...
                : a.url
                  ...
                  : a.json
                    ...
                    : a.rows
                      ? b.load(
                            b.convertDataToTargets(b.convertRowsToData(a.rows)),
                            a,
                        )
                      : a.columns
                        ? b.load(
                              b.convertDataToTargets(
                                  b.convertColumnsToData(a.columns),
                              ),
                              a,
                          )
                        : b.load(null, a);
                          ...
                          ((c.withoutFadeIn[a] = !1),
                              c.legend &&
                                  c.legend
                                      ...
                                      .remove(),
                              (c.data.targets = c.data.targets.filter(
                                  function (b) {
                                      return b.id !== a;
                                  },
                              )));
            ...
            function e(b, c, e) {
                ...
                var g,
                    ...
                    l =
                        k.width +
                        C +
                        (!j || u.isLegendRight || u.isLegendInset ? y : 0),
                    m = k.height + x,
                    ...
                    .on('mouseover', function (a) {
                        (u.d3.select(this).classed(l.legendItemFocused, !0),
                            !u.transiting &&
                                u.isTargetToShow(a) &&
                                u.api.focus(a),
                            v.legend_item_onmouseover &&
                                v.legend_item_onmouseover.call(u, a));
                    })
                    .on('mouseout', function (a) {
                        (u.d3.select(this).classed(l.legendItemFocused, !1),
                            u.api.revert(),
                            v.legend_item_onmouseout &&
                                v.legend_item_onmouseout.call(u, a));
                    })),
                m
                    .append('text')
                    .text(function (a) {
        ...
        (i.updateAngle = function (a) {
            ...
            return (
                d
                    .pie(d.filterTargetsToShow(d.data.targets))
                    .forEach(function (b) {
                        (f ||
                            b.data.id !== a.data.id ||
                            ((f = !0), (a = b), (a.index = g)),
        ...
        (i.initSubchart = function () {
            ...
            (c.style('visibility', b.subchart_show ? 'visible' : 'hidden'),
                ...
                (a.axes.subx = c
                    ...
                    .attr(
                        'clip-path',
                        b.axis_rotated ? '' : a.clipPathForXAxis,
                    )));
        }),
