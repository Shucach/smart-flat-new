    ...
    var c = {
        ...
        d = function (d, e) {
            if (
                ...
                (this.container =
                    this.container !== !1 ? a(this.container) : !1),
            ...
            (this.picker.on(
                ...
                this.picker.appendTo(
                    this.container ? this.container : a('body'),
                ),
                this.input !== !1 &&
                    (this.input.on({
                ...
                if (
                    ...
                    if (this.options.colorSelectors) {
                        var c = new b(a, this.options.colorSelectors),
                            d = c.toAlias();
                        'undefined' != typeof this.options.colorSelectors[d] &&
                            (a = d);
                    }
                    ...
                    ? (this.options.horizontal === !1
                          ? ((c = this.options.sliders),
                            d
                                ...
                                .css(
                                    'top',
                                    c.hue.maxTop * (1 - this.color.value.h),
                                )
                                .end()
                                .eq(2)
                                .css(
                                    'top',
                                    c.alpha.maxTop * (1 - this.color.value.a),
                                ))
                          : ((c = this.options.slidersHorz),
                            d
                                ...
                                .css(
                                    'left',
                                    c.hue.maxLeft * (1 - this.color.value.h),
                                )
                                .end()
                                .eq(2)
                                .css(
                                    'left',
                                    c.alpha.maxLeft * (1 - this.color.value.a),
                                )),
                      d.eq(0).css({
                          top:
                              c.saturation.maxTop -
