    ...
    var b = null,
        ...
        g = function () {
            if (null === b) {
                var c,
                    d,
                    e = a('<p/>').addClass('fixed-table-scroll-inner'),
        ...
        h = function (b, d, e, f) {
            ...
            return 'object' == typeof g
                ...
                : 'function' == typeof g
                  ? g.apply(b, e)
                  : !g && 'string' == typeof d && c.apply(this, [d].concat(e))
                    ? c.apply(this, [d].concat(e))
                    : f;
        },
        i = function (b, c, d) {
    ...
    ((p.DEFAULTS = {
                    ...
                    (e.push('<tr>'),
                        ...
                        a.each(g, function (a, f) {
                            ...
                            if (
                                ...
                                if (
                                    ((b.header.fields[f.fieldIndex] = f.field),
                                    (b.header.styles[f.fieldIndex] = i + j),
                                    (b.header.classes[f.fieldIndex] = k),
                                    (b.header.formatters[f.fieldIndex] =
                                        f.formatter),
                                    (b.header.events[f.fieldIndex] = f.events),
                                    (b.header.sorters[f.fieldIndex] = f.sorter),
                                    (b.header.sortNames[f.fieldIndex] =
                                        f.sortName),
                                    (b.header.cellStyles[f.fieldIndex] =
                                        f.cellStyle),
                                    (b.header.searchables[f.fieldIndex] =
                                        f.searchable),
                                    !f.visible)
                                )
                                    return;
                            ...
                            (e.push(
                                ...
                                f.checkbox || f.radio
                                    ...
                                    : k,
                                c(' style="%s"', h + j),
                                c(' rowspan="%s"', f.rowspan),
                                c(' colspan="%s"', f.colspan),
                                c(' data-field="%s"', f.field),
                                "tabindex='0'",
                                '>',
                            ),
                                e.push(
                ...
                : void (
                      ...
                      this.data.sort(function (f, g) {
                          ...
                          return void 0 !== k
                              ...
                              : ((void 0 === i || null === i) && (i = ''),
                                (void 0 === j || null === j) && (j = ''),
                                b.options.sortStable &&
                                    i === j &&
                                    ((i = f._position), (j = g._position)),
                                a.isNumeric(i) && a.isNumeric(j)
                                    ? ((i = parseFloat(i)),
                                      (j = parseFloat(j)),
                                      j > i ? -1 * d : d)
                                    : i === j
        ...
        (p.prototype.initToolbar = function () {
            ...
            (this.$toolbar.find('.bs-bars').children().length &&
                ...
                'string' == typeof this.options.icons &&
                    (this.options.icons = h(null, this.options.icons)),
                this.options.showPaginationSwitch &&
                    f.push(
                        c(
                            '<button class="btn' +
                                c(' btn-%s', this.options.buttonsClass) +
                    ...
                    a.each(this.columns, function (a, b) {
                        if (
                            !(
                                b.radio ||
                                b.checkbox ||
                                (e.options.cardView && !b.cardVisible)
                            )
                        ) {
                            ...
                            b.switchable &&
                                (f.push(
                                    c(
                                        '<li><label><input type="checkbox" data-field="%s" value="%s"%s> %s</label></li>',
                                        b.field,
                                        a,
                                        d,
                                        b.title,
                    ...
                    f.push(
                        ...
                        c(
                            '<input class="form-control' +
                                c(' input-%s', this.options.iconSize) +
        ...
        (p.prototype.initSearch = function () {
            ...
            if ('server' !== this.options.sidePagination) {
                ...
                var c =
                    ...
                    d = a.isEmptyObject(this.filterColumns)
                        ? null
                        : this.filterColumns;
                ((this.data = d
                        ...
                        ? a.grep(this.data, function (d, f) {
                              for (var g = 0; g < b.header.fields.length; g++)
                                  if (b.header.searchables[g]) {
                                      var i,
                                          j = a.isNumeric(b.header.fields[g])
                                              ? parseInt(b.header.fields[g], 10)
                                              : b.header.fields[g],
                    ...
                    var q =
                        'string' == typeof this.options.pageList
                            ? this.options.pageList
                                  ...
                                  .split(',')
                            : this.options.pageList;
                    a.inArray(this.options.formatAllRows().toLowerCase(), q) >
                        -1 && (n = !0);
                }
                ((this.totalPages =
                    ~~((this.options.totalRows - 1) / this.options.pageSize) +
                    1),
            ...
            if (
                ...
                m.push(
                    ...
                    this.options.onlyInfoPagination
                        ? this.options.formatDetailPagination(
                              this.options.totalRows,
                          )
                ...
                var r = [
                    ...
                    n ? this.options.formatAllRows() : this.options.pageSize,
                    '</span>',
                    ' <span class="caret"></span>',
                    '</button>',
                    '<ul class="dropdown-menu" role="menu">',
                ...
                if ('string' == typeof this.options.pageList) {
                    ...
                    ((p = []),
                        a.each(s, function (a, b) {
                            p.push(
                                b.toUpperCase() ===
                                    l.options.formatAllRows().toUpperCase()
                                    ? l.options.formatAllRows()
                                    : +b,
                            );
                        }));
                }
                for (
                    a.each(p, function (a, b) {
                        if (
                            !l.options.smartDisplay ||
                            0 === a ||
                            p[a - 1] <= l.options.totalRows
                        ) {
                            var d;
                            ((d = n
                                ? b === l.options.formatAllRows()
                                    ? ' class="active"'
                                    : ''
                                : b === l.options.pageSize
                                  ? ' class="active"'
                                  : ''),
                                r.push(
                                    c(
                        ...
                        this.totalPages < 5
                            ? ((d = 1), (e = this.totalPages))
                            : ((d = this.options.pageNumber - 2),
                              (e = d + 4),
                              1 > d && ((d = 1), (e = 5)),
                              e > this.totalPages &&
                                  ((e = this.totalPages), (d = e - 4))),
                        this.totalPages >= 6 &&
            ...
            (this.$pagination.html(m.join('')),
                this.options.onlyInfoPagination ||
                    ...
                    this.options.smartDisplay &&
                        ...
                        (p.length < 2 || this.options.totalRows <= p[0]) &&
                            this.$pagination.find('span.page-list').hide(),
                        this.$pagination[
                            this.getData().length ? 'show' : 'hide'
                        ]()),
                    n && (this.options.pageSize = this.options.formatAllRows()),
                    f
                        .off('click')
                        .on('click', a.proxy(this.onPageListChange, this)),
                    ...
                    k
                        .off('click')
                        .on('click', a.proxy(this.onPageNumber, this))));
        }),
        ...
        (p.prototype.initBody = function (b) {
            ...
            (this.trigger('pre-body', i),
                ...
                (this.options.pagination &&
                    'server' !== this.options.sidePagination) ||
                    ((this.pageFrom = 1), (this.pageTo = i.length)));
            for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
                var l,
                    ...
                    s = [];
                if (
                    ((o = h(this.options, this.options.rowStyle, [n, k], o)),
                    o && o.css)
                )
                    for (l in o.css) p.push(l + ': ' + o.css[l]);
                if (
                    (r = h(this.options, this.options.rowAttributes, [n, k], r))
                )
                    for (l in r) s.push(c('%s="%s"', l, j(r[l])));
                (n._data &&
                    !a.isEmptyObject(n._data) &&
                    a.each(n._data, function (a, b) {
                        'index' !== a && (q += c(' data-%s="%s"', a, b));
                    }),
                    g.push(
                        '<tr',
                        c(' %s', s.join(' ')),
                        c(' id="%s"', a.isArray(n) ? void 0 : n._id),
                        c(
                            ' class="%s"',
                            o.classes || (a.isArray(n) ? void 0 : n._class),
                        ),
                        c(' data-index="%s"', k),
                        c(' data-uniqueid="%s"', n[this.options.uniqueId]),
                        c('%s', q),
                        '>',
                    ),
                    ...
                    a.each(this.header.fields, function (b, e) {
                        ...
                        if (
                            !(
                                (f.fromHtml && 'undefined' == typeof j) ||
                                !x.visible ||
                                (f.options.cardView && !x.cardVisible)
                            )
                        ) {
                            if (
                                ((o = c(
                                    'style="%s"',
                                    p.concat(f.header.styles[b]).join('; '),
                                )),
                                n['_' + e + '_id'] &&
                                    (r = c(' id="%s"', n['_' + e + '_id'])),
                                n['_' + e + '_class'] &&
                                ...
                                o = c(
                                    'style="%s"',
                                    y.concat(f.header.styles[b]).join('; '),
                                );
                            }
                            ((j = h(x, f.header.formatters[b], [j, n, k], j)),
                                ...
                                x.checkbox || x.radio
                                    ? ((l = x.checkbox ? 'checkbox' : l),
                                      ...
                                      (n[f.header.stateField] =
                                          j === !0 || (j && j.checked)))
                                    : ((j =
                                          'undefined' == typeof j || null === j
                                              ? f.options.undefinedText
                                              : j),
                                      (i = f.options.cardView
                                          ? [
                                                '<div class="card-view">',
                                                f.options.showHeader
                                                    ? c(
            ...
            (g.length ||
                ...
                this.$body
                    ...
                    .on('click dblclick', function (b) {
                        var d = a(this),
                            ...
                            k =
                                j[
                                    f.options.detailView && !f.options.cardView
                                        ? i - 1
                                        : i
                                ],
                        ...
                        if (
                            ...
                            'click' === b.type &&
                                f.options.clickToSelect &&
                                l.clickToSelect)
                        ) {
                            var o = g.find(
                                c('[name="%s"]', f.options.selectItemName),
                            );
                            o.length && o[0].click();
                        }
                    }),
                ...
                (this.$selectItem = this.$body.find(
                    c('[name="%s"]', this.options.selectItemName),
                )),
                this.$selectItem.off('click').on('click', function (b) {
                    ...
                    (f.options.maintainSelected &&
                        a(this).is(':radio') &&
                        a.each(f.options.data, function (a, b) {
                            b[f.header.stateField] = !1;
                        }),
                        (e[f.header.stateField] = d),
                        f.options.singleSelect &&
                            (f.$selectItem.not(this).each(function () {
                                f.data[a(this).data('index')][
                                    f.header.stateField
                                ] = !1;
                            }),
                            f.$selectItem
            ...
            (this.options.pagination &&
                ...
                (d || this.options.url || this.options.ajax) &&
                    ...
                    g !== !1 &&
                        ...
                        this.options.ajax
                            ? h(this, this.options.ajax, [e], null)
                            : (this._xhr &&
        ...
        (p.prototype.updateSelected = function () {
            var b =
                ...
                this.$selectItem.filter(':enabled').length ===
                    this.$selectItem.filter(':enabled').filter(':checked')
                        .length;
            (this.$selectAll.add(this.$selectAll_).prop('checked', b),
                this.$selectItem.each(function () {
                    a(this)
                        .closest('tr')
                        [a(this).prop('checked') ? 'addClass' : 'removeClass'](
                            'selected',
                        );
                }));
        }),
        ...
        (p.prototype.fitHeader = function () {
            var b,
                ...
                h = this;
            if (h.$el.is(':hidden'))
                return void (h.timeoutId_ = setTimeout(
                    a.proxy(h.fitHeader, h),
                    100,
                ));
            if (
            ...
            ((this.$header_ = this.$header.clone(!0, !0)),
                ...
                this.$header.find('th[data-field]').each(function () {
                    h.$header_
                        .find(c('th[data-field="%s"]', a(this).data('field')))
                        .data(a(this).data());
                }));
            ...
            (this.$body
                ...
                this.$tableBody.off('scroll').on('scroll', function () {
                    (h.$tableHeader.scrollLeft(a(this).scrollLeft()),
                        h.options.showFooter &&
                            !h.options.cardView &&
                            h.$tableFooter.scrollLeft(a(this).scrollLeft()));
                }),
                ...
                a.each(this.columns, function (a, f) {
                    ...
                    if (f.visible && (!b.options.cardView || f.cardVisible)) {
                        ...
                        (e.push(
                            '<td',
                            m,
                            c(' style="%s"', i + j + k.concat().join('; ')),
                            '>',
                        ),
                            e.push('<div class="th-inner">'),
                            e.push(
                                h(f, f.footerFormatter, [d], '&nbsp;') ||
                                    '&nbsp;',
                            ),
                            e.push('</div>'),
                            e.push('<div class="fht-cell"></div>'),
            ...
            if (
                ...
                (d && e.filter(c('[value="%s"]', a)).prop('checked', b),
                    e.filter(':checked').length <=
                        ...
                        e.filter(':checked').prop('disabled', !0));
            }
        }),
            ...
            return this.options.cardView
                ...
                : (this.options.showHeader && this.options.height
                  ...
                  this.options.showFooter &&
                      (this.resetFooter(),
                      this.options.height &&
                          (b += this.$tableFooter.outerHeight() + 1)),
                  this.getCaret(),
        ...
        (p.prototype.load = function (b) {
            var c = !1;
            ('server' === this.options.sidePagination
                ? ((this.options.totalRows = b.total),
                  (c = b.fixedScroll),
        ...
        (p.prototype.insertRow = function (a) {
            a.hasOwnProperty('index') &&
                ...
                (this.data.splice(a.index, 0, a.row),
                this.initSearch(),
                this.initPagination(),
                this.initSort(),
                this.initBody(!0));
        ...
        (p.prototype.showRow = function (a) {
            (a.hasOwnProperty('index') || a.hasOwnProperty('uniqueId')) &&
                this.toggleRow(a.index, a.uniqueId, !0);
        }),
        (p.prototype.hideRow = function (a) {
            (a.hasOwnProperty('index') || a.hasOwnProperty('uniqueId')) &&
                this.toggleRow(a.index, a.uniqueId, !1);
        }),
        ...
        (p.prototype.check_ = function (a, b) {
            var d = this.$selectItem
                .filter(c('[data-index="%s"]', b))
                .prop('checked', a);
        ...
        (p.prototype.expandRow_ = function (a, b) {
            ...
            d.next().is('tr.detail-view') === (a ? !1 : !0) &&
                d.find('> td > .detail-icon').click();
        }),
        ...
        (p.prototype.expandAllRows = function (b) {
            if (b) {
                var d = this.$body.find(c('> tr[data-index="%s"]', 0)),
                    ...
                    h = -1;
                if (
                    (d.next().is('tr.detail-view')
                        ? d.next().next().is('tr.detail-view') ||
                          (d.next().find('.detail-icon').click(), (g = !0))
                        : (d.find('> td > .detail-icon').click(), (g = !0)),
                    g)
                )
                    try {
        ...
        (p.prototype.updateFormatText = function (a, b) {
            (this.options[c('format%s', a)] &&
                ('string' == typeof b
                    ? (this.options[c('format%s', a)] = function () {
                          return b;
                      })
                    : 'function' == typeof b &&
                      (this.options[c('format%s', a)] = b)),
                this.initToolbar(),
                this.initPagination(),
                this.initBody());
        }));
