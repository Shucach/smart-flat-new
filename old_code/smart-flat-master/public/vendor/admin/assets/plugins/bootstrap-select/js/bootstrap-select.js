        ...
        Selectpicker.prototype = {
                ...
                this.$element.find('option').each(function (index) {
                    ...
                    if (isOptgroup && $this.data('divider') !== true) {
                        ...
                        if (
                            ...
                            liIndex++;
                            _li.push(
                                generateLI('', null, 'divider', optID + 'div'),
                            );
                        }
                        _li.push(
                            generateLI(
            ...
            keydown: function (e) {
                ...
                if (/(38|40)/.test(e.keyCode.toString(10))) {
                    index = $items.index(
                        $items.find('a').filter(':focus').parent(),
                    );
                    ...
                    $items.each(function () {
                        if (!$(this).hasClass('disabled')) {
                            if (
                                $.trim(
                                    $(this).children('a').text().toLowerCase(),
