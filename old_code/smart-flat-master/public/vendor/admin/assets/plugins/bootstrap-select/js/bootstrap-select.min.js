                ...
                createLi: function () {
                    ...
                    if (
                        ...
                        ((g.className = 'bs-title-option'),
                            ...
                            void 0 ===
                                a(k.options[k.selectedIndex]).attr(
                                    'selected',
                                ) && (g.selected = !0));
                    }
                    return (
                ...
                setSize: function () {
                    if (
                        ...
                        var b,
                            ...
                            t = function () {
                                ((d =
                                    f.$newElement.offset().top - i.scrollTop()),
                                    (e = i.height() - d - j));
                            };
                        if ((t(), 'auto' === this.options.size)) {
                            var u = function () {
                                var i,
                                    ...
                                    p =
                                        f.$menuInner[0].getElementsByTagName(
                                            'li',
                                        ),
                                ...
                                (t(),
                                    ...
                                    f.options.container
                                        ? (g.data('height') ||
                                              g.data('height', g.height()),
                                          (c = g.data('height')))
                                        : (c = g.height()),
                                    f.options.dropupAuto &&
                                        f.$newElement.toggleClass(
                                            'dropup',
                                            d > e && c > b - r,
                                        ),
                                    f.$newElement.hasClass('dropup') &&
                                        (b = d - r),
                                    (i =
                                        s.length + u.length > 3
                                            ? 3 * k + r - 2
                        ...
                        this.$searchbox.on('input propertychange', function () {
                            ...
                            (d.$lis.filter('.active').removeClass('active'),
                                d.$searchbox.val() &&
                                    d.$lis
                                        .not(
                                            '.hidden, .divider, .dropdown-header',
                                        )
                                        .eq(0)
                                        .addClass('active')
                                        .children('a')
