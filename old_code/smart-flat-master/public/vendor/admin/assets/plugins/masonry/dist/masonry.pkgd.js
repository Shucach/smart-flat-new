...
(function (window, factory) {
    ...
    function factory(window, EventEmitter, getSize, getStyleProperty, utils) {
        ...
        Item.prototype.layoutPosition = function () {
            ...
            // y
            var yPadding = layoutOptions.isOriginTop
                ? 'paddingTop'
                : 'paddingBottom';
        ...
        Item.prototype.transition =
            Item.prototype[
                transitionProperty ? '_transition' : '_nonTransition'
            ];
...
(function (window, factory) {
    ...
    function factory(window, eventie, EventEmitter, getSize, utils, Item) {
        ...
        Outlayer.prototype._getBoundingRect = function () {
            ...
            this._boundingRect = {
                left:
                    boundingRect.left + size.paddingLeft + size.borderLeftWidth,
        ...
        Outlayer.prototype._getElementOffset = function (elem) {
            ...
            var offset = {
                ...
                bottom:
                    thisRect.bottom - boundingRect.bottom - size.marginBottom,
            };
            return offset;
        };
