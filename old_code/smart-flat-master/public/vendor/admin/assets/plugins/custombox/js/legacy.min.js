...
function cbExtendObjects() {
    for (var a = 1, b = arguments.length; b > a; a++)
        for (var c in arguments[a])
            arguments[a].hasOwnProperty(c) &&
                (arguments[0][c] = arguments[a][c]);
    return arguments[0];
}
if (
    ((function (a) {
            ...
            (Object.defineProperty ||
                (Object.defineProperty = function (a, g, h) {
                    ...
                    if (!(h.writable && h.enumerable && h.configurable))
                        throw new TypeError(
                            'This implementation of Object.defineProperty does not support false for configurable, enumerable, or writable.',
                        );
                    return (
                        h.get && b.call(a, g, h.get),
    ...
    var propDescriptor = {
        ...
        get: function () {
            ...
            for (a = 0; i > a; a++)
                if (
                    ((f = h[a]), f && f.name && /^data-\w[\w\-]*$/.test(f.name))
                ) {
                    ((c = f.value),
                        (d = f.name),
...
('document' in self &&
    ...
    (function (a, b, c) {
        if (
            (!a.addEventListener || !a.removeEventListener) &&
            a.attachEvent &&
            a.detachEvent
        ) {
            var d = function (a) {
                ...
                j = function (a) {
                    ...
                    if (b)
                        ...
                        ((a.addEventListener = h), (a.removeEventListener = i));
                    return a;
                };
    ...
    Array.prototype.forEach ||
        (Array.prototype.forEach = function (a, b) {
            ...
            for (arguments.length >= 2 && (c = b), d = 0; g > d;)
                (d in f && ((e = f[d]), a.call(c, e, d, f)), d++);
        }),
    (function (a, b) {
        try {
