    ...
    var a = {
        ...
        c = {
            set: function (c) {
                ...
                (this.cb.push({
                    settings:
                        b.oldIE && 'undefined' != typeof cbExtendObjects
                            ? cbExtendObjects({}, a, c)
                            : Object.assign({}, a, c),
                }),
                    'auto' === this.cb[this.item].settings.overlayEffect &&
            ...
            init: function () {
                (document.documentElement.classList.add('custombox-open'),
                    ...
                    this.cb[this.item].settings.loading &&
                        ...
                        this.built('loading'),
                    this.cb[this.item].settings.overlay
                ...
                switch (
                    ...
                    case 'overlay':
                        (c.overlay || (c.overlay = {}),
                            ...
                            c.overlay.classList.add(
                                'custombox-overlay-' + c.settings.overlayEffect,
                            ),
                            (c.overlay.style.zIndex = c.settings.zIndex + 2),
                            (c.overlay.style.backgroundColor =
                                c.settings.overlayColor),
                            b.overlay.perspective.indexOf(
                                c.settings.overlayEffect,
                            ) > -1 ||
                            b.overlay.together.indexOf(
                                c.settings.overlayEffect,
                            ) > -1
                                ? (c.overlay.style.opacity =
                                      c.settings.overlayOpacity)
                                : c.overlay.classList.add(
                                      'custombox-overlay-default',
                                  ),
                            (c.overlay.style.transitionDuration =
                                b.overlay.together.indexOf(
                                    c.settings.overlayEffect,
                                ) > -1
                                    ? c.settings.speed + 'ms'
                                    : c.settings.overlaySpeed + 'ms'),
                    ...
                    case 'modal':
                        ('push' === c.settings.overlayEffect &&
                            (this.main.style.transitionDuration =
                                c.settings.speed + 'ms'),
                            ...
                            c.wrapper.classList.add(
                                'custombox-modal-wrapper-' + c.settings.effect,
                            ),
                            ...
                            b.modal.position.indexOf(c.settings.effect) > -1 &&
                                null === c.settings.animation &&
                                (c.settings.animation =
                                    'slide' === c.settings.effect
                                        ? ['top']
                                        : 'flip' === c.settings.effect
                                          ? ['horizontal']
                                          : ['bottom']),
                            (c.modal = document.createElement('div')),
                            c.modal.classList.add('custombox-modal'),
                            c.modal.classList.add(
                                'custombox-modal-' +
                                    c.settings.effect +
                                    (b.modal.position.indexOf(
                                        c.settings.effect,
                                    ) > -1
                                        ? '-' + c.settings.animation[0].trim()
                                        : ''),
                            ),
                            (c.modal.style.transitionDuration =
                                c.settings.speed + 'ms'),
                    ...
                    case 'loading':
                        ...
                        for (
                            ...
                            d.classList.add(
                                this.cb[this.item].settings.loading.parent[e],
                            );
                        if (
                            (this.loading.appendChild(d),
            ...
            load: function () {
                ...
                if (
                    ('function' == typeof a.settings.open &&
                        a.settings.open.call(),
                ...
                return (
                    null !== a.settings.target &&
                    Array.isArray(a.settings.position)
                        ? '#' === a.settings.target.charAt(0) ||
                          ('.' === a.settings.target.charAt(0) &&
                              '/' !== a.settings.target.charAt(1))
                            ? document.querySelector(a.settings.target)
                                ? ((a.inline = document.createElement('div')),
                                  (a.content = document.querySelector(
                                      a.settings.target,
                                  )),
                                  (a.display =
                                      'none' === a.content.style.display),
                                  (a.content.style.display = 'block'),
                                  a.content.parentNode.insertBefore(
                                      a.inline,
                                      a.content,
                                  ),
                                  this.size())
            ...
            size: function () {
                ...
                if (
                    ...
                    a.inline ||
                        (b.oldIE
                            ? (a.content.style.styleFloat = 'none')
                            : (a.content.style.cssFloat = 'none')),
                    null !== a.settings.width &&
                        (isNaN(a.settings.width)
                            ? ((c = window.innerWidth),
                              (a.content.style.height =
                                  window.innerHeight + 'px'))
                            : (c = parseInt(a.settings.width, 0))),
                    (a.size = c),
                    a.size + 60 >= window.innerWidth)
                ) {
                    ((a.container.style.width = 'auto'),
                        'full' !== a.settings.width &&
                            (a.container.style.margin = '5%'),
                        (a.wrapper.style.width = window.innerWidth + 'px'));
                    for (
                        var d = 0,
                            e = a.content.querySelectorAll(':scope > *'),
                            f = e.length;
                        f > d;
                        d++
                    )
                        e[d].offsetWidth > window.innerWidth &&
                            (e[d].style.width = 'auto');
                } else {
                ...
                if (
                    ((a.content.style.width = 'auto'),
                    a.modal.appendChild(a.content),
                    a.content.offsetHeight >= window.innerHeight &&
                        'full' !== a.settings.width)
                )
                    ...
                    4 === d.readyState &&
                        (200 === d.status
                            ? ((e.innerHTML = d.responseText),
                              ...
                              b.oldIE
                                  ? (c.content.style.styleFloat = 'left')
                                  : (c.content.style.cssFloat = 'left'),
            ...
            open: function () {
                var a = this,
                    ...
                    d = a.scrollbar();
                if (
                    (d && (document.body.style.paddingRight = d + 'px'),
                    ...
                    if (
                        ...
                        b.overlay.together.indexOf(c.settings.overlayEffect) >
                            -1
                            ? c.overlay.classList.add('custombox-overlay-open')
                            : (c.overlay.style.opacity =
                                  c.settings.overlayOpacity),
                        b.overlay.together.indexOf(c.settings.overlayEffect) >
                            -1 || b.oldIE)
            ...
            remove: function (a) {
                ...
                if (
                    (1 === c.cb.length &&
                        ...
                        'undefined' != typeof d.scroll &&
                            window.scrollTo(0, d.scroll)),
                    d.inline &&
                        (b.oldIE
                            ? (d.content.style.removeAttribute('width'),
                              d.content.style.removeAttribute('height'),
                              d.content.style.removeAttribute('display'))
                            : (d.content.style.removeProperty('width'),
                    ...
                    c.main.classList.remove(
                        'custombox-container-' + d.settings.overlayEffect,
                    ),
                    d.wrapper.parentNode.removeChild(d.wrapper),
                    d.settings.overlay &&
                        d.overlay.parentNode.removeChild(d.overlay),
                    'function' == typeof d.settings.close &&
                        d.settings.close.call(),
                    document.createEvent)
                ) {
            ...
            close: function (a) {
                ...
                } else c = d.cb.length - 1;
                var g = d.cb[c];
                if (
                    (b.modal.position.indexOf(g.settings.effect) > -1 &&
                        g.settings.animation.length > 1 &&
                        (g.modal.classList.remove(
                            'custombox-modal-' +
                                g.settings.effect +
                                '-' +
                                g.settings.animation[0],
                        ),
                        g.modal.classList.add(
                            'custombox-modal-' +
                                g.settings.effect +
                                '-' +
                                g.settings.animation[1].trim(),
                        )),
                    g.wrapper.classList.remove('custombox-modal-open'),
                    b.oldIE ||
                        b.oldMobile ||
                        b.overlay.together.indexOf(g.settings.overlayEffect) >
                            -1)
                )
                    d.clean(c);
                else {
                    ...
                    b.modal.animationend.indexOf(g.settings.effect) > -1
                        ? g.wrapper.addEventListener('animationend', h, !1)
                        : g.wrapper.addEventListener('transitionend', h, !1);
                }
            },
            responsive: function () {
                b.oldIE &&
                ...
                for (var a, c = 0, d = this.cb.length; d > c; c++) {
                    if (this.cb[c].size + 60 >= window.innerWidth)
                        ('full' !== this.cb[c].settings.width &&
                            ((this.cb[c].container.style.marginLeft = '5%'),
                            (this.cb[c].container.style.marginRight = '5%')),
                            (this.cb[c].container.style.width = 'auto'),
                            (this.cb[c].wrapper.style.width =
                        ...
                        switch (this.cb[c].settings.position[0].trim()) {
                            ...
                            case 'right':
                                ...
                                break;
                            default:
                                ((this.cb[c].container.style.marginLeft =
                                    'auto'),
                                    (this.cb[c].container.style.marginRight =
                                        'auto'));
                        }
                        ((this.cb[c].container.style.width =
                            this.cb[c].size + 'px'),
                            (this.cb[c].wrapper.style.width = 'auto'));
                    }
                    if (
                        this.cb[c].content.offsetHeight >= window.innerHeight &&
                        'full' !== this.cb[c].settings.width
                    )
                        ...
                        switch (this.cb[c].settings.position[1].trim()) {
                            ...
                            case 'bottom':
                                a =
                                    window.innerHeight -
                                    this.cb[c].content.offsetHeight +
                                    'px';
                                break;
                            default:
                                a =
                                    window.innerHeight / 2 -
                                    this.cb[c].content.offsetHeight / 2 +
                                    'px';
                        }
            ...
            binds: function () {
                ...
                (1 === a.cb.length &&
                    ((a.esc = function (b) {
                        (1 === a.cb.length &&
                            document.removeEventListener('keydown', a.esc),
                            (b = b || window.event),
                            !d &&
                                27 === b.keyCode &&
                                a.get() &&
                                a.get().settings.escKey &&
                                ((d = !0), a.close()));
                    }),
                ...
                var e = function () {
                        if (!c.inline)
                            for (
                                var a = 0,
                                    b = c.modal.getElementsByTagName('script'),
                                    d = b.length;
                                d > a;
                                a++
                            )
                ...
                b.oldIE || b.oldMobile
                    ? setTimeout(function () {
                          e();
                      }, c.settings.overlaySpeed)
                    : 'slit' !== c.settings.effect
                      ? c.modal.addEventListener('transitionend', f, !1)
                      : c.modal.addEventListener('animationend', f, !1);
            },
            error: function () {
                var a = this,
                    b = a.cb.length - 1;
