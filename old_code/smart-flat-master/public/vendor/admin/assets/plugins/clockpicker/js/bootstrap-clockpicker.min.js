    ...
    function s(s, n) {
        ...
        if (
            ...
            (c(
                ...
                .on('click', function () {
                    ((H.amOrPm = 'AM'),
                        c('.clockpicker-span-am-pm').empty().append('AM'));
                })
        ...
        if (
            (h.on(u, function (t) {
                0 === c(t.target).closest('.clockpicker-tick').length &&
                    a(t, !0);
            }),
            p)
        ) {
    ...
    ((s.DEFAULTS = {
        ...
        (s.prototype.remove = function () {
            (this.element.removeData('clockpicker'),
                ...
                this.isAppended &&
                    (n.off('resize.clockpicker' + this.id),
                    this.popover.remove()));
        }),
