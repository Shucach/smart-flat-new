...
!(function (a) {
    ...
    var b = a(window),
        ...
        n =
            /^(naturalWidth|naturalHeight|width|height|aspectRatio|ratio|rotate)$/i,
        o = 'cropper-modal',
        p = 'cropper-hidden',
        q = 'cropper-invisible',
        r = 'cropper-move',
    ...
    ((I.prototype = {
        ...
        build: function () {
            ...
            this.ready &&
                ...
                b.isDefaultPrevented() ||
                    ...
                    !g.dashed &&
                        this.$dragger.find('.cropper-dashed').addClass(p),
                    !g.movable &&
                        this.$dragger.find('.cropper-face').addClass(p),
                    !g.resizable &&
                        this.$dragger
        ...
        destroy: function () {
            var a = this.$element;
            this.ready &&
                (this.unbuild(), a.removeClass(p), a.removeData('cropper'));
        },
        replace: function (b) {
            var c,
                d = this,
            ...
            if (!this.disabled) {
                ...
                if (((c = c || a(i.target).data(j)), l.test(c))) {
                    ...
                    ((this.directive = c),
                        ...
                        (this.startY = i.pageY),
                        'crop' === c &&
                            ((this.cropping = d), this.$canvas.addClass(o)));
                }
            }
        },
        dragmove: function (b) {
            ...
            if (!this.disabled && this.directive) {
                ...
                (this.cropping &&
                    ...
                    this.$canvas.toggleClass(
                        o,
                        this.cropped && this.defaults.modal,
                    )),
                    (this.directive = ''));
            }
        },
                    ...
                    t.x &&
                        ...
                        t.x > 0
                            ...
                            : t.y > 0
                              ...
                              : ((b = 'nw'), (l -= j), (m -= k)),
                        this.cropped ||
                            ((this.cropped = d), this.$dragger.removeClass(p)));
            }
            (q &&
                ((i.width = j),
                (i.height = k),
