...
(!(function ($) {
    ...
    //creates area graph
    ((RickshawChart.prototype.createAreaGraph = function (
        selector,
        seriesData,
        random,
        colors,
        ...
        (RickshawChart.prototype.createSimpleareaGraph = function (
            selector,
            simpleAdata,
            colors,
        ) {
        ...
        (RickshawChart.prototype.createMultipleareaGraph = function (
            selector,
            multipleAdata1,
            multipleAdata2,
            colors,
        ...
        (RickshawChart.prototype.createLinetoggleGraph = function (
            selector,
            height,
            colors,
            names,
            ...
            var hoverDetail = new Rickshaw.Graph.HoverDetail({
                ...
                formatter: function (series, x, y) {
                    var date =
                        ...
                        '</span>';
                    var swatch =
                        '<span class="detail_swatch" style="background-color: #000' +
                        series.color +
                        '"></span>';
                    var content =
                        swatch +
        ...
        (RickshawChart.prototype.createLinePlotGraph = function (
            selector,
            colors,
            names,
        ) {
        ...
        (RickshawChart.prototype.createMultiGraph = function (
            selector,
            height,
            names,
            colors,
        ...
        //init dashboard
        ($.RickshawChart = new RickshawChart()),
        ($.RickshawChart.Constructor = RickshawChart));
})(window.jQuery),
