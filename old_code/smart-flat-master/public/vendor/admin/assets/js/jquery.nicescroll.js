    ...
    var A = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        P = function () {
            ...
            a: {
                ...
                for (l = 0; l < k.length; l++)
                    if (
                        ((q = k[l]), (e.style.cursor = q), e.style.cursor == q)
                    ) {
                        k = q;
                        break a;
                    }
        ...
        Q = function (h, c) {
            ...
            this.hasParent = function (b, c) {
                if (!b) return !1;
                for (
                    var f = b.target || b.srcElement || b || !1;
                    f && f.id != c;
                )
                    f = f.parentNode || !1;
                return !1 !== f;
            ...
            this.init = function () {
                ...
                if (
                    !b.ispage ||
                    (!g.cantouch && !g.isieold && !g.isie9mobile)
                ) {
                    var d = b.docscroll;
            ...
            this.doScrollBy = function (c, g) {
                ...
                if (b.bouncescroll) {
                    ...
                    f < -e
                        ? (f = -e)
                        : f > b.page.maxh + e && (f = b.page.maxh + e);
                }
                b.cursorfreezed = !1;
                py = b.getScrollTop(!0);
            ...
            this.doScrollLeftBy = function (c, g) {
                ...
                if (b.bouncescroll) {
                    ...
                    f < -e
                        ? (f = -e)
                        : f > b.page.maxw + e && (f = b.page.maxw + e);
                }
                b.cursorfreezed = !1;
                px = b.getScrollLeft(!0);
                if (
                    (0 > f && 0 >= px) ||
                    (f > b.page.maxw && px >= b.page.maxw)
                )
            ...
            this.doZoomIn = function (c) {
                if (!b.zoomactive) {
                    ...
                    for (l in k) {
                        var h = k[l];
                        b.zoomrestore.style[h] =
                            'undefined' != typeof f[h] ? f[h] : '';
                    }
