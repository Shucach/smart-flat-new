                ...
                if (e) {
                    ...
                    for (var o = 0; r > o; o++)
                        if (v.State.calls[o]) {
                            ...
                            for (
                                var y = Math.min((t - f) / u.duration, 1),
                                    h = 0,
                                    b = l.length;
                                b > h;
                                h++
                                ...
                                if (i(w)) {
                                    ...
                                    (u.mobileHA &&
                                        ...
                                        ((i(w).transformCache.translate3d =
                                            '(0px, 0px, 0px)'),
                                        (V = !0)),
                        ...
                        i(p) &&
                            ...
                            ($.each(i(p).tweensContainer, function (e, t) {
                                (e.startsWith('rotate') &&
                                    ...
                                    e.startsWith('backgroundPosition') &&
            ...
            var x = (v.CSS = {
                ...
                Normalizations: {
                        ...
                        clip: function (e, t, r) {
                            switch (e) {
                                ...
                                case 'extract':
                                    var a;
                                    return (
                                        x.RegEx.wrappedValueAlreadyExtracted.test(
                                            r,
                                        )
                                            ? (a = r)
                                            : ((a = r
                                                  .toString()
                                                  .match(x.RegEx.valueUnwrap)),
                                              (a = a
                                                  ? a[1].replace(
                                                        /,(\s+)?/g,
                                                        ' ',
                    ...
                    register: function () {
                        9 >= f ||
                            ...
                            (x.Lists.transformsBase =
                                x.Lists.transformsBase.concat(
                                    x.Lists.transforms3D,
                                ));
                        for (var e = 0; e < x.Lists.transformsBase.length; e++)
                            !(function () {
                                var t = x.Lists.transformsBase[e];
                                x.Normalizations.registered[t] = function (
                                    e,
                                    r,
                                    n,
                                ) {
                ...
                getPropertyValue: function (e, r, n, o) {
                    ...
                    if (x.Hooks.registered[r]) {
                        var u = r,
                            c = x.Hooks.getRoot(u);
                        (n === a &&
                            (n = x.getPropertyValue(
                                e,
                                x.Names.prefixCheck(c)[0],
                            )),
                            x.Normalizations.registered[c] &&
                                (n = x.Normalizations.registered[c](
                                    'extract',
                                    e,
                                    n,
                                )),
                        ...
                        ((p = x.Normalizations.registered[r]('name', e)),
                            ...
                            (l = x.Normalizations.registered[r](
                                'extract',
                                e,
                                d,
                            )));
                ...
                setPropertyValue: function (e, r, a, n, o) {
                    ...
                    if ('scroll' === r)
                        ...
                        'transform' ===
                            x.Normalizations.registered[r]('name', e)
                    )
                        ...
                        if (
                            (x.Normalizations.registered[r] &&
                                ((a = x.Normalizations.registered[r](
                                    'inject',
                                    e,
                                    a,
                                )),
                                (r = x.Normalizations.registered[r](
                                    'name',
                                    e,
                                ))),
                    ...
                    function e(e) {
                        ...
                        if ('scroll' === k) {
                            var S = /^x$/i.test(o.axis) ? 'Left' : 'Top',
                                ...
                                F;
                            (o.container
                                ? g.isWrapped(o.container) ||
                                  g.isNode(o.container)
                                    ? ((o.container =
                                          o.container[0] || o.container),
                                      (C = o.container['scroll' + S]),
                                      (F =
                                          C +
                                          $(n).position()[S.toLowerCase()] +
                                          V))
                                    : (o.container = null)
                                : ((C =
                                      v.State.scrollAnchor[
                                          v.State['scrollProperty' + S]
                                      ]),
                                  (A =
                                      v.State.scrollAnchor[
                                          v.State[
                            ...
                            for (var j in E)
                                if ('element' !== j) {
                                    ...
                                    ((E[j].startValue = E[j].currentValue =
                                        E[j].endValue),
                                        (E[j].endValue = H),
                                        g.isEmptyObject(b) ||
                                            (E[j].easing = o.easing),
                                        ...
                                        o._cacheValues && E && E[R]
                                            ? (M === a &&
                                                  (M =
                                                      ...
                                                      E[R].unitType),
                                              (B =
                                                  i(n).rootPropertyValueCache[
                                                      I
                                                  ]))
                                            : x.Hooks.registered[R]
                                              ? M === a
                                                  ? ((B = x.getPropertyValue(
                                                        n,
                                                        I,
                                                    )),
                                                    (M = x.getPropertyValue(
                                                        n,
                                                        R,
                                                        B,
                                                    )))
                                                  : (B =
                                                        x.Hooks.templates[I][1])
                                              : M === a &&
                                                (M = x.getPropertyValue(n, R)));
                                    var W,
                                        G,
                                        D,
                                        X = !1;
                        ...
                        s.element &&
                            ...
                            L.push(s),
                            '' === o.queue &&
                                ((i(n).tweensContainer = s), (i(n).opts = o)),
                            (i(n).isAnimating = !0),
                            w === P - 1
                                ? (v.State.calls.push([
                                      L,
                        ...
                        default:
                            if (!$.isPlainObject(h) || g.isEmptyObject(h)) {
                                if (g.isString(h) && v.Redirects[h]) {
                                    ...
                                    return (
                                        F.backwards === !0 &&
                                            (m = $.extend(!0, [], m).reverse()),
                                        $.each(m, function (e, t) {
                                            (parseFloat(F.stagger)
                                                ? (F.delay =
                                                      j +
                                                      parseFloat(F.stagger) * e)
                                                : g.isFunction(F.stagger) &&
                                                  (F.delay =
                                                      j +
                                                      F.stagger.call(t, e, P)),
                                                F.drag &&
                                                    ((F.duration =
                                                        parseFloat(E) ||
...
!(function (a, b, c, d) {
    ...
    function B(a, b) {
        for (
            var c, f, g = b[0].toUpperCase() + b.slice(1), h = 0;
            h < e.length;
        ) {
        ...
        p(bc, ac, {
            ...
            attrTest: function (a) {
                return (
                    ...
                    (this.state & Sb ||
                        (!(this.state & Sb) && this.directionTest(a)))
                );
            },
            emit: function (a) {
            ...
            process: function (a) {
                ...
                if (d && e && c) {
                    ...
                    var f = this.pTime
                        ...
                        g =
                            !this.pCenter ||
                            kb(this.pCenter, a.center) < b.posThreshold;
